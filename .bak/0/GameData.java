...
public final class GameData {
   ...
   private void d() {
      ...
      try {
         System.gc();
         Thread.yield();
         DataInputStream var6 = new DataInputStream(this.getClass().getResourceAsStream(this.a_obj_StringArr[this.a_byte]));
         byte[] var7 = new byte[62502];
         var6.read(var7);
         var6.close();
         int var8 = 0;
         var3 = 0;
         ...
         while (true) {
            ...
            try {
               if (var3 < 27) {
                  this.a_obj_f.a_obj_ImageArr2[this.a_byte][var3] = Image.createImage(var7, var8, var5);
               }
            } catch (Exception var10) {
            }
   ...
   private void g() {
      try {
         ...
         InputStream var1;
         (var1 = this.getClass().getResourceAsStream("/sa")).read(GameResources.w_byteArr, 0, 26616);
         var1.close();
