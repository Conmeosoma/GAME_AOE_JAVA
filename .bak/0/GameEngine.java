...
public final class GameEngine {
   ...
   public GameEngine() {
      ...
      this.a_intArr[8] = 255;
      this.a_intArr[9] = 511;
      this.a_intArr[10] = 1023;
      this.a_intArr[11] = 2047;
      this.a_intArr[12] = 4095;
      this.a_intArr[13] = 8191;
      this.a_intArr[14] = 16383;
      this.a_intArr[15] = 32767;
      this.a_intArr[16] = 65535;
      this.a_intArr[17] = 131071;
      this.a_intArr[18] = 262143;
      this.a_intArr[19] = 524287;
      this.a_intArr[20] = 1048575;
      this.a_intArr[21] = 2097151;
      this.a_intArr[22] = 4194303;
      this.a_intArr[23] = 8388607;
      this.a_intArr[24] = 16777215;
      this.a_intArr[25] = 33554431;
   }
   ...
   final void a_void2() {
      ...
      for (this.a_int = 0; this.a_int < 10; this.a_int++) {
         this.c_byteArr2[4][this.a_int] = 0;
      }

      for (this.a_int = 0; this.a_int < 6; this.a_int++) {
         this.d_shortArr[this.a_int] = -1;
      }

      for (this.a_int = 0; this.a_int < 10; this.a_int++) {
         this.f_byteArr2[0][this.a_int] = 0;
      }

      for (this.a_int = 0; this.a_int < 20; this.a_int++) {
         this.g_byteArr2[0][this.a_int] = 0;
      }

      for (this.a_int = 0; this.a_int < 50; this.a_int++) {
         this.j_byteArr[this.a_int] = (byte)this.a_int;
      }
         ...
         for (this.a_int = 0; this.a_int < this.c_byte; this.a_int++) {
            ...
            if (!this.a_boolArr[0] && !this.a_boolArr[1]) {
               ...
               if (this.m_int < 0) {
                  ...
                  this.f_byteArr[this.g_byteArr[(this.m_int & 1) + 1]] = (byte)((this.m_int >> 1) + 1);
                  this.a_boolArr[this.m_int & 1] = true;
                  this.a_void5(false);
                  this.a_boolArr[this.m_int & 1] = false;
               }
               break;
            }
   ...
   private byte a_byte3(int var1, int var2, int var3, int var4) {
      try {
         ...
         for (this.a_int = 0; this.a_int < this.c_byte; this.a_int++) {
            ...
            if (!this.a_boolArr[0] && !this.a_boolArr[1]) {
               this.d_void(0);
               this.d_byteArr2[0][this.d_int] = this.m_int < 0
                  ? this.e_byteArr3[0][0][this.a_int]
                  : this.d_byteArr3[this.g_byteArr[(this.m_int & 1) + 1]][0][this.m_int >> 1];
               this.d_byteArr2[1][this.d_int] = this.m_int < 0
                  ? this.e_byteArr3[0][1][this.a_int]
                  : this.d_byteArr3[this.g_byteArr[(this.m_int & 1) + 1]][1][this.m_int >> 1];
            ...
            this.b_int = (!this.a_boolArr[0] || this.f_byteArr[this.g_byteArr[1]] >= this.f_byteArr[this.g_byteArr[2]]) && this.a_boolArr[1] ? 2 : 1;
            this.d_byteArr2[0][this.d_int] = this.d_byteArr3[this.g_byteArr[this.b_int]][0][this.f_byteArr[this.g_byteArr[this.b_int]] / 2];
            this.d_byteArr2[1][this.d_int] = this.d_byteArr3[this.g_byteArr[this.b_int]][1][this.f_byteArr[this.g_byteArr[this.b_int]] / 2];
            this.a_int = this.e_byteArr[this.g_byteArr[this.b_int]];
            this.d_int++;
         }
   ...
   private void d_void(int var1) {
      ...
      this.m_int = -1;
      if (this.l_int > this.B_int) {
         this.n_int = this.f_byteArr[this.g_byteArr[this.f_byteArr[this.g_byteArr[1]] > this.f_byteArr[this.g_byteArr[2]] ? 1 : 2]] * 2;

         for (this.j_int = 0; this.j_int < this.n_int; this.j_int++) {
            if (this.f_byteArr[this.g_byteArr[(this.j_int & 1) + 1]] > this.j_int >> 1) {
               this.k_int = (this.q_byte - this.d_byteArr3[this.g_byteArr[(this.j_int & 1) + 1]][0][this.j_int >> 1])
                     * (this.q_byte - this.d_byteArr3[this.g_byteArr[(this.j_int & 1) + 1]][0][this.j_int >> 1])
                  + (this.r_byte - this.d_byteArr3[this.g_byteArr[(this.j_int & 1) + 1]][1][this.j_int >> 1])
                     * (this.r_byte - this.d_byteArr3[this.g_byteArr[(this.j_int & 1) + 1]][1][this.j_int >> 1]);
               if (this.k_int < this.l_int) {
                  this.l_int = this.k_int;
                  this.m_int = this.j_int;
                  if (this.a_int2(
   ...
   private byte b_byte2(int var1, int var2, int var3, int var4) {
      ...
      for (this.j_byte = 0; this.j_byte < this.h_byte; this.j_byte++) {
         this.i_byte = (byte)(
            this.i_byte
               + this.a_byte2(
                  this.d_byteArr2[1][this.j_byte],
                  this.d_byteArr2[0][this.j_byte],
                  this.d_byteArr2[1][this.j_byte + 1],
                  this.d_byteArr2[0][this.j_byte + 1],
                  this.i_byte,
                  0
               )
         );
   ...
   private void o_void() {
      if (this.a_byteArr[4848 + this.v_int] > 1) {
         this.a_byteArr[4848 + this.v_int] = 0;
      }

      this.a_boolArr[2] = true;
      this.a_byteArr[808 + this.v_int] = this.b_byte2(
         this.a_byteArr[101 + this.v_int], this.a_byteArr[0 + this.v_int], this.a_byteArr[3232 + this.v_int], this.a_byteArr[3131 + this.v_int]
      );
   }
   ...
   private void p_void() {
      this.o_void();
      if (this.a_byteArr[808 + this.v_int] < 1
         && this.a_int2(this.a_byteArr[0 + this.v_int], this.a_byteArr[101 + this.v_int], 0) / 10 > this.B_int) {
         this.a_byteArr[4848 + this.v_int]++;
         if (!this.a_boolArr[2]) {
            return;
         }

         this.a_byteArr[7979 + this.v_int] = (byte)(this.a_byteArr[7979 + this.v_int] & 223);
         if (this.b_byteArr[this.a_shortArr[39] + this.a_byteArr[2828 + this.v_int]] == 1) {
            this.b_void(this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]], this.a_byteArr[4444 + this.v_int]);
         }

         if (this.a_byteArr[2828 + this.v_int] == 69
            || this.a_byteArr[2828 + this.v_int] == 79
            || this.a_byteArr[2828 + this.v_int] == 59
            || this.a_byteArr[2828 + this.v_int] == 87) {
            this.a_byteArr[4848 + this.v_int] = 0;
            if (this.a_byteArr[6464 + this.v_int] == 69
               && this.a_byteArr[6262 + this.v_int] == this.a_byteArr[3131 + this.v_int]
               && this.a_byteArr[6363 + this.v_int] == this.a_byteArr[3232 + this.v_int]) {
               this.a_byteArr[6262 + this.v_int] = this.a_byteArr[0 + this.v_int];
               this.a_byteArr[6363 + this.v_int] = this.a_byteArr[101 + this.v_int];
            }
         ...
         if (this.a_byteArr[2828 + this.v_int] == 17
            || this.a_byteArr[2828 + this.v_int] == 109
            || this.a_byteArr[2828 + this.v_int] == 110
            || this.a_byteArr[2828 + this.v_int] == 27) {
            this.N();
            return;
         }

         if (this.b_byteArr[this.a_shortArr[39] + this.a_byteArr[2828 + this.v_int]] != 1 && this.a_byteArr[2828 + this.v_int] > 9) {
            this.a_bool4(
               0,
      ...
      } else if (this.a_byteArr[808 + this.v_int] > 0
         && (
   ...
   private void a_void3(int var1, int var2, int var3, int var4, int var5) {
      try {
         ...
         for (this.a_int = 0; this.a_int < 3; this.a_int++) {
            if (this.e_byteArr[this.a_int] < this.b_int) {
               this.b_int = this.e_byteArr[this.a_int];
               this.g_byteArr[0] = (byte)this.a_int;
            }
         }

         this.g_byteArr[1] = (byte)((this.g_byteArr[0] + 1) % 3);
         this.g_byteArr[2] = (byte)((this.g_byteArr[0] + 2) % 3);
         this.d_byte = 0;
         this.c_byte = 0;
   ...
   private void e_void(int var1) {
      ...
      for (this.e_int = 0; this.e_int < 2; this.e_int++) {
         this.c_int = 0;

         for (this.a_int = this.e_int; this.a_int != 2 - 3 * this.e_int; this.a_int = this.a_int + (1 - 2 * this.e_int)) {
            for (this.b_int = 0; this.b_int < this.c_byteArr[this.a_int]; this.c_int++) {
               this.d_byteArr[this.e_int << 1] = (byte)(
                  this.d_byteArr[this.e_int << 1] + this.b_byteArr[this.a_shortArr[0] + this.a_byte * 4 + this.a_int * 2]
               );
               this.d_byteArr[(this.e_int << 1) + 1] = (byte)(
                  this.d_byteArr[(this.e_int << 1) + 1] + this.b_byteArr[this.a_shortArr[0] + this.a_byte * 4 + this.a_int * 2 + 1]
               );
               this.d_byteArr3[this.e_int][0][this.c_int] = this.d_byteArr[this.e_int << 1];
               this.d_byteArr3[this.e_int][1][this.c_int] = this.d_byteArr[(this.e_int << 1) + 1];
               this.e_byteArr[this.e_int] = (byte)(
                  this.e_byteArr[this.e_int]
                     + (
      ...
      this.e_int = 0;
      this.f_int = 0;
      this.b_int = this.g_int = this.c_byteArr[1] > 0 ? this.c_byteArr[0] * 50 / this.c_byteArr[1] : 1000000;

      for (this.a_int = 0; this.a_int < this.c_byteArr[0] + this.c_byteArr[1]; this.a_int++) {
         if ((this.b_int < 50 || this.e_int >= this.c_byteArr[0]) && this.f_int < this.c_byteArr[1]) {
            this.d_byteArr[4] = (byte)(this.d_byteArr[4] + this.b_byteArr[this.a_shortArr[0] + this.a_byte * 4 + 2]);
            this.d_byteArr[5] = (byte)(this.d_byteArr[5] + this.b_byteArr[this.a_shortArr[0] + this.a_byte * 4 + 3]);
            this.f_int++;
            this.b_int = this.b_int + this.g_int;
         } else {
            this.d_byteArr[4] = (byte)(this.d_byteArr[4] + this.b_byteArr[this.a_shortArr[0] + this.a_byte * 4 + 0]);
            this.d_byteArr[5] = (byte)(this.d_byteArr[5] + this.b_byteArr[this.a_shortArr[0] + this.a_byte * 4 + 1]);
            this.e_int++;
            this.b_int -= 50;
         }
   ...
   private void f_void(int var1) {
      try {
         ...
         for (this.e_int = 1; this.e_int < 3; this.e_int++) {
            this.h_int = this.g_byteArr[this.e_int];
            this.f_byteArr[this.h_int] = 0;
            this.a_boolArr[this.e_int - 1] = false;
            this.b_byte = this.b_byteArr[this.a_shortArr[3]
               + this.d_byteArr3[this.g_byteArr[0]][0][this.e_byteArr3[0][2][this.a_int] + 1]
               - this.e_byteArr3[0][0][this.a_int]
               + (this.d_byteArr3[this.g_byteArr[0]][1][this.e_byteArr3[0][2][this.a_int] + 1] - this.e_byteArr3[0][1][this.a_int]) * 3
               + 4];
            this.d_byteArr[this.h_int * 2] = this.e_byteArr3[0][0][this.a_int];
            this.d_byteArr[this.h_int * 2 + 1] = this.e_byteArr3[0][1][this.a_int];
            ...
            for (this.b_int = 0; this.b_int < 65; this.b_int++) {
               for (this.f_int = 0; this.f_int < 8; this.f_int++) {
                  ...
                  if (this.c_int == 0) {
                     if ((this.b_byte & 1) > 0) {
                        ...
                        if (this.d_byteArr[this.h_int * 2] + this.b_byteArr[this.a_shortArr[1] + (this.b_byte + this.g_int & 7)]
                              == this.e_byteArr3[0][0][this.a_int]
                           && this.d_byteArr[this.h_int * 2 + 1] + this.b_byteArr[this.a_shortArr[1] + 8 + (this.b_byte + this.g_int & 7)]
                              == this.e_byteArr3[0][1][this.a_int]) {
                           this.b_int = 130;
                           break;
                        }
                     ...
                     this.d_byteArr[this.h_int * 2] = (byte)(this.d_byteArr[this.h_int * 2] + this.b_byteArr[this.a_shortArr[1] + this.b_byte]);
                     this.d_byteArr[this.h_int * 2 + 1] = (byte)(this.d_byteArr[this.h_int * 2 + 1] + this.b_byteArr[this.a_shortArr[1] + 8 + this.b_byte]);
                     break;
                  }

                  this.b_byte = (byte)(this.b_byte + this.g_int & 7);
               }
               ...
               this.d_byteArr3[this.h_int][0][this.b_int] = this.d_byteArr[this.h_int * 2];
               this.d_byteArr3[this.h_int][1][this.b_int] = this.d_byteArr[this.h_int * 2 + 1];
               this.f_byteArr[this.h_int]++;
               this.b_byte = (byte)(this.b_byte - this.g_int * 2 & 7);
            }
   ...
   private void a_void5(boolean var1) {
      ...
      for (this.e_int = 0; this.e_int <= this.e_byteArr3[0][2][this.a_int]; this.e_int++) {
         this.d_byteArr3[this.g_byteArr[2]][0][this.e_int] = this.d_byteArr3[this.g_byteArr[0]][0][this.e_int];
         this.d_byteArr3[this.g_byteArr[2]][1][this.e_int] = this.d_byteArr3[this.g_byteArr[0]][1][this.e_int];
      }

      this.f_byteArr[this.g_byteArr[2]] = (byte)(this.e_byteArr3[0][2][this.a_int] + 1);

      for (this.e_int = 0;
         this.e_int <= this.f_byteArr[this.g_byteArr[1]] && this.e_int + this.f_byteArr[this.g_byteArr[2]] < this.i_int;
         this.e_int++
      ) {
         this.d_byteArr3[this.g_byteArr[2]][0][this.e_int + this.f_byteArr[this.g_byteArr[2]]] = this.d_byteArr3[this.g_byteArr[1]][0][this.e_int];
         this.d_byteArr3[this.g_byteArr[2]][1][this.e_int + this.f_byteArr[this.g_byteArr[2]]] = this.d_byteArr3[this.g_byteArr[1]][1][this.e_int];
      }

      this.f_byteArr[this.g_byteArr[2]] = (byte)b_int2(this.f_byteArr[this.g_byteArr[2]] + this.f_byteArr[this.g_byteArr[1]], 0, this.i_int);
      ...
      if (var1 && this.f_byteArr[this.g_byteArr[0]] < this.i_int) {
         ...
         for (this.e_int = 0;
            this.e_int <= this.f_byteArr[this.g_byteArr[2]] - this.g_int && this.e_int + this.f_byteArr[this.g_byteArr[0]] < this.i_int;
            this.e_int++
         ) {
            this.d_byteArr3[this.g_byteArr[0]][0][this.e_int + this.f_byteArr[this.g_byteArr[0]]] = this.d_byteArr3[this.g_byteArr[2]][0][this.e_int
               + this.g_int];
            this.d_byteArr3[this.g_byteArr[0]][1][this.e_int + this.f_byteArr[this.g_byteArr[0]]] = this.d_byteArr3[this.g_byteArr[2]][1][this.e_int
               + this.g_int];
         }

         this.f_byteArr[this.g_byteArr[0]] = (byte)b_int2(this.f_byteArr[this.g_byteArr[0]] + this.f_byteArr[this.g_byteArr[2]] - this.g_int, 0, this.i_int);
         this.a_int = this.e_byteArr[this.g_byteArr[1]];

         for (this.e_int = this.a_int + 1; this.e_int < this.c_byte; this.e_int++) {
            this.e_byteArr3[0][2][this.e_int] = (byte)(this.e_byteArr3[0][2][this.e_int] + this.h_int);
            this.e_byteArr3[1][2][this.e_int] = (byte)(this.e_byteArr3[1][2][this.e_int] + this.h_int);
         }
      }
   }
   ...
   private void h_void(int var1) {
      ...
      if (this.m_byte == 2 || this.m_byte == 7) {
         this.a_byteArr[7979 + this.v_int] = (byte)(
            this.a_byteArr[2828 + this.v_int] != 60
               ...
               ? this.a_byteArr[7979 + this.v_int] | 128
               : this.a_byteArr[7979 + this.v_int] & 127
         );
      }
      ...
      if (this.a_byteArr[1414 + this.v_int] >= 12
         ...
         this.a_void7(this.v_int, this.m_byte);
      }

      if (this.a_byteArr[2828 + this.v_int] == 13) {
         if (this.a_byteArr[3131 + this.v_int] > 0
            && (
      ...
      if (this.b_byteArr[this.a_shortArr[39] + this.a_byteArr[2828 + this.v_int]] == 1) {
         this.b_void(this.k_byteArr[1], this.k_byteArr[2]);
      }
   }
   ...
   private void a_void6(int var1, int var2, boolean var3) {
      ...
      if (this.k_byteArr[3] == 0) {
         ...
         if (this.k_byte == 2) {
            ...
            if (this.k_byteArr[1] >= 12
               && this.a_byteArr[8505 + this.k_byteArr[2]] >= this.b_byteArr[this.a_shortArr[138] + 182 + this.a_byteArr[9237 + this.k_byteArr[2]]]) {
               this.m_byte = 69;
            }
         }
   ...
   private void b_void(int var1, int var2) {
      ...
      for (this.p_int = 10000; this.a_int < this.b_byteArr[this.a_shortArr[20] + var1]; this.a_int++) {
         ...
         if (this.q_int < this.a_obj_f.c_short
            ...
            this.q_int = (this.a_byteArr[0 + this.v_int] - this.q_int) * (this.a_byteArr[0 + this.v_int] - this.q_int)
               + (this.a_byteArr[101 + this.v_int] - this.r_int) * (this.a_byteArr[101 + this.v_int] - this.r_int);
            if (this.p_int > this.q_int) {
               this.p_int = this.q_int;
               this.o_int = this.a_int;
            }
         }
      }
   ...
   private void q_void() {
      this.p_byte = this.a_byteArr[4444 + this.v_int];
      if (this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[26] + this.a_byteArr[2828 + this.v_int]]] + this.p_byte] <= 0) {
         this.r_void();
      }

      if ((this.b_byteArr[this.a_shortArr[27] + this.a_byteArr[2828 + this.v_int]] & 2) > 0) {
         this.n_byte = (byte)(this.a_int2(this.a_byteArr[0 + this.v_int], this.a_byteArr[101 + this.v_int], 0) / 10);
         if (this.a_byteArr[2828 + this.v_int] == 92 || this.a_byteArr[2828 + this.v_int] == 106) {
            if (this.n_byte > this.a_byteArr[1818 + this.v_int]) {
               this.b_void2(false);
               this.a_void7(
                  this.v_int,
                  this.b_byteArr[this.a_shortArr[57]
                     + this.b_byteArr[this.a_shortArr[174] + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]]
                     + this.a_byteArr[4646 + this.v_int]]
               );
               this.i_void(0);
               this.a_byteArr[3030 + this.v_int] = -1;
               return;
            }

            this.a_byteArr[3131 + this.v_int] = this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[28] + this.a_byteArr[2828 + this.v_int]]]
               + this.p_byte];
            this.a_byteArr[3232 + this.v_int] = this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[28] + this.a_byteArr[2828 + this.v_int]] + 1]
               + this.p_byte];
            return;
         }

         if (this.n_byte <= this.a_byteArr[4949 + this.v_int] + 2) {
            if (this.a_byteArr[3131 + this.v_int]
                  != this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[28] + this.a_byteArr[2828 + this.v_int]]] + this.p_byte]
               || this.a_byteArr[3232 + this.v_int]
                  != this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[28] + this.a_byteArr[2828 + this.v_int]] + 1] + this.p_byte]) {
               this.a_byteArr[3131 + this.v_int] = this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[28] + this.a_byteArr[2828 + this.v_int]]]
                  + this.p_byte];
               this.a_byteArr[3232 + this.v_int] = this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[28] + this.a_byteArr[2828 + this.v_int]] + 1]
                  + this.p_byte];
               if (this.n_byte > this.B_int) {
                  this.p_void();
         ...
         if (this.a_byteArr[808 + this.v_int] == 0) {
            if (this.a_byteArr[2828 + this.v_int] <= 9 && this.a_byteArr[6161 + this.v_int] == 0) {
               this.Q();
               this.a_byteArr[3131 + this.v_int] = this.a_byteArr[0 + this.v_int];
               this.a_byteArr[3232 + this.v_int] = this.a_byteArr[101 + this.v_int];
               return;
   ...
   private void r_void() {
      if (this.a_byteArr[2828 + this.v_int] == 2 || this.a_byteArr[2828 + this.v_int] == 7) {
         if ((this.a_byteArr[7979 + this.v_int] & 128) == 0) {
            this.g_void(1);
         } else {
            this.Q();
         }
      ...
      if (this.a_byteArr[2828 + this.v_int] == 93 || this.a_byteArr[2828 + this.v_int] == 92 || this.a_byteArr[2828 + this.v_int] == 106) {
         this.b_void2(false);
         this.a_void7(
            this.v_int,
            this.b_byteArr[this.a_shortArr[57]
      ...
      if ((this.b_byteArr[this.a_shortArr[27] + this.a_byteArr[2828 + this.v_int]] & 1) > 0) {
         if (this.a_byteArr[1414 + this.v_int] < 12) {
            this.Q();
         } else {
            if (this.a_byteArr[6565 + this.v_int] == 9 && (this.a_byteArr[2828 + this.v_int] == 0 || this.a_byteArr[2828 + this.v_int] == 3)) {
               this.a_byteArr[2828 + this.v_int] = (byte)(this.a_byteArr[2828 + this.v_int] ^ 1);
            }

            this.a_bool = this.b_bool = true;
            if (this.a_byteArr[2828 + this.v_int] > 9 || !this.p_bool()) {
               this.Q();
               if ((this.a_byteArr[2929 + this.v_int] & 255) > 7) {
                  this.a_byteArr[3131 + this.v_int] = this.a_byteArr[0 + this.v_int];
                  this.a_byteArr[3232 + this.v_int] = this.a_byteArr[101 + this.v_int];
               }
            }
      ...
      if (this.a_byteArr[2828 + this.v_int] >= 94 && this.a_byteArr[2828 + this.v_int] <= 96) {
         this.ap();
      }
   }
         ...
         if ((this.a_byteArr[8749 + this.s_int] == 11 || var1) && this.a_byteArr[8932 + this.s_int] >= 1) {
            for (this.t_int = this.a_byteArr[8993 + this.s_int]; this.t_int > 0; this.t_int = this.a_byteArr[4545 + this.t_int]) {
               if (this.t_int == this.v_int) {
                  ...
                  this.a_byteArr[4747 + this.v_int] = (byte)(-this.s_int);
                  this.a_byteArr[3131 + this.v_int] = this.a_byteArr[0 + this.v_int];
                  this.a_byteArr[3232 + this.v_int] = this.a_byteArr[101 + this.v_int];
                  return;
               }
   ...
   final void c_void() {
      for (this.v_int = 1; this.v_int <= 50; this.v_int++) {
         this.a_byteArr[7979 + this.v_int] = (byte)(this.a_byteArr[7979 + this.v_int] & 159);
         if (this.a_byteArr[1919 + this.v_int] > 0 && this.a_byteArr[2828 + this.v_int] == 69 && this.a_byteArr[6161 + this.v_int] == 0) {
            this.a_void15(this.v_int, false);
         }
      }
   }
      ...
      try {
         ...
         for (this.u_int = 0; this.u_int < 2; this.u_int++) {
            ...
            if (this.a_shortArr2[this.u_int][18] >= 0) {
               this.a_shortArr2[this.u_int][18]++;
            }
            ...
            for (this.v_int = this.u_int * 50 + 1; this.v_int <= (this.u_int + 1) * 50; this.v_int++) {
               if (this.a_byteArr[1919 + this.v_int] != 0 && !this.a_bool2()) {
                  if (this.a_byteArr[4545 + this.v_int] > -111 || this.a_byteArr[4545 + this.v_int] < -122) {
                     this.t_void();
                     if (this.a_byteArr[7575 + this.v_int] > 3 && this.h_bool2()) {
                        continue;
                     }
                  ...
                  this.v_void();
                  this.b_bool = true;
                  if (this.a_byteArr[5050 + this.v_int] == 0
                     && this.a_byteArr[1414 + this.v_int] >= 12
                     && this.a_byteArr[2828 + this.v_int] != 50
                     && this.a_byteArr[2828 + this.v_int] != 105) {
                     this.a_bool = (
                           this.a_byteArr[6161 + this.v_int] == 0
                              || (this.I_byte & this.u_int + 1) != 0
                              || this.a_byteArr[6161 + this.v_int] == 1
                                 && this.a_byteArr[808 + this.v_int] <= this.a_byteArr[707 + this.v_int]
                                 && this.z_int / 10 > this.B_int
                                 && (this.a_byteArr[2929 + this.v_int] & 255) > 7
                        )
                        && (
                           this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] == this.v_int
                              || this.b_byteArr[this.a_shortArr[41] + this.a_byteArr[2828 + this.v_int]] == 16
                                 && this.b_byteArr[this.a_shortArr[18] + this.a_byteArr[6565 + this.v_int]] > 0
                        )
                        && (this.a_byteArr[7979 + this.v_int] & 2) == 0
                        && (this.a_byteArr[2828 + this.v_int] > 9 || (this.b_byteArr[this.a_shortArr[27] + this.a_byteArr[2828 + this.v_int]] & 4) == 0);
                     this.b_bool = false;
                     this.p_bool();
                  }
         ...
         for (this.v_int = 1; this.v_int <= 4; this.v_int++) {
            if (this.a_shortArr2[0][this.v_int] > 999) {
   ...
   private boolean a_bool2() {
      if (this.a_byteArr[1919 + this.v_int] < 0) {
         ...
         if (this.f_byte == 2 && this.u_int == 0 && (this.a_byteArr[1717 + this.v_int] > 4 || this.a_byteArr[1616 + this.v_int] > 4)) {
            this.F_int++;
         }

         this.B_int = this.b_byteArr[this.a_shortArr[38] + this.a_byteArr[2828 + this.v_int]];
         if (this.B_int < 0) {
            this.B_int = this.a_byteArr[this.b_shortArr[-this.B_int] + this.v_int];
         }

         if ((this.a_byteArr[8282 + this.v_int] & 128) != 0
            && this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] == this.v_int) {
            ...
            if ((this.a_obj_f.c_int & 3) == (this.v_int & 3) && !this.q_bool()) {
               ...
               if (this.a_byteArr[2828 + this.v_int] <= 9 && this.a_byteArr[2828 + this.v_int] != 2 && this.a_byteArr[2828 + this.v_int] != 7) {
                  this.K_byte = 0;
               }

               this.a_byteArr[5050 + this.v_int]++;
               ...
               if (this.a_byteArr[3333 + this.v_int] >= 11
                  && this.a_byteArr[2929 + this.v_int] != 39
                  && this.a_byteArr[2929 + this.v_int] != 104
                  && this.a_byteArr[2929 + this.v_int] != 105) {
   ...
   private void t_void() {
      if (this.a_byteArr[6161 + this.v_int] >= 2 && this.a_byteArr[202 + this.v_int] == 0 && this.a_byteArr[303 + this.v_int] == 0) {
         if (this.c_bool = this.a_byteArr[6161 + this.v_int] == 2) {
            this.a_void6(this.a_byteArr[3131 + this.v_int], this.a_byteArr[3232 + this.v_int], true);
            if (this.l_byte >= 0) {
               this.c_bool = false;
            }
         ...
         if (this.u_int != 1
            && this.a_byteArr[505 + this.v_int] < 10
            && this.a_byteArr[6161 + this.v_int] == 2
            && this.b_byteArr[this.a_shortArr[41] + this.m_byte] != 0) {
            this.a_byteArr[6161 + this.v_int] = 0;
            this.a_byteArr[3131 + this.v_int] = this.a_byteArr[0 + this.v_int];
            this.a_byteArr[3232 + this.v_int] = this.a_byteArr[101 + this.v_int];
            this.a_byteArr[4444 + this.v_int] = this.a_byteArr[4747 + this.v_int] = 0;
            this.Q();
            this.a_void19((byte)12, this.v_int, 0);
         } else if (!this.a_bool3((byte)-1, this.c_bool)) {
            if (this.a_byteArr[6161 + this.v_int] == 4) {
               this.a_byteArr[4444 + this.v_int] = (byte)(this.a_byteArr[4747 + this.v_int] - (this.a_byteArr[4747 + this.v_int] <= 100 ? 0 : 101));
               this.a_byteArr[4747 + this.v_int] = (byte)(this.a_byteArr[4747 + this.v_int] <= 100 ? 0 : 99);
               this.a_byteArr[3131 + this.v_int] = this.a_byteArr[this.b_shortArr[this.a_byteArr[4747 + this.v_int]] + this.a_byteArr[4444 + this.v_int]];
               this.a_byteArr[3232 + this.v_int] = this.a_byteArr[this.b_shortArr[this.a_byteArr[4747 + this.v_int] + 1]
                  + this.a_byteArr[4444 + this.v_int]];
               if (this.a_int2(this.a_byteArr[0 + this.v_int], this.a_byteArr[101 + this.v_int], 0) / 10 <= this.a_byteArr[4949 + this.v_int]) {
                  this.g_void(1);
                  this.a_byteArr[6161 + this.v_int] = 0;
               } else {
            ...
            if (this.a_byteArr[6161 + this.v_int] > 0) {
               this.g_void(this.a_byteArr[6161 + this.v_int] == 2 ? 0 : 2);
               return;
            }
         }
      }
   ...
   private boolean b_bool2() {
      ...
      if (this.a_byteArr[202 + this.v_int] == 0 && this.a_byteArr[303 + this.v_int] == 0 && this.a_byteArr[6161 + this.v_int] < 2) {
         if (this.a_byteArr[2828 + this.v_int] == 109) {
            this.o_bool();
         }

         if (this.a_byteArr[5050 + this.v_int] >= this.a_byteArr[1010 + this.v_int] - this.a_byteArr[7777 + this.v_int]
            && ((this.a_byteArr[2929 + this.v_int] & 255) <= 7 || this.a_byteArr[3030 + this.v_int] == 0)) {
            if (this.a_byteArr[1414 + this.v_int] >= 12 && this.m_bool()) {
               this.a_byteArr[3636 + this.v_int] = 0;
               return true;
            }

            if ((
                     this.b_byteArr[this.a_shortArr[31] + this.a_byteArr[2828 + this.v_int]] == 13
                           && this.b_byteArr[this.a_shortArr[33] + this.a_byteArr[2828 + this.v_int]] == 13
                  ...
                  && this.a_byteArr[2929 + this.v_int] != -109
                  && this.a_byteArr[3131 + this.v_int] == this.a_byteArr[0 + this.v_int]
                  && this.a_byteArr[3232 + this.v_int] == this.a_byteArr[101 + this.v_int]
               || this.a_byteArr[4444 + this.v_int] == -1) {
               if (this.a_byteArr[4444 + this.v_int] == -1
                  && this.a_byteArr[2828 + this.v_int] >= 10
                  && this.a_byteArr[2828 + this.v_int] <= 16
                  && this.a_byteArr[3636 + this.v_int] > 0) {
                  this.an();
               } else {
                  this.n_bool();
            ...
            if ((
               ...
               && this.a_byteArr[1414 + this.v_int] >= 12
               && (this.a_byteArr[2828 + this.v_int] == 69 || this.a_byteArr[2828 + this.v_int] == 84 && this.a_byteArr[3939 + this.v_int] == 69)
               && this.a_byteArr[7777 + this.v_int] == 0
               && this.a_byteArr[6161 + this.v_int] == 0
               && (
                  this.a_byteArr[3131 + this.v_int] != this.a_byteArr[6262 + this.v_int]
                     || this.a_byteArr[3232 + this.v_int] != this.a_byteArr[6363 + this.v_int]
               )) {
               this.a_void6(this.a_byteArr[6262 + this.v_int], this.a_byteArr[6363 + this.v_int], true);
               this.Q();
               if (this.b_byteArr[this.a_shortArr[41] + this.m_byte] != this.b_byteArr[this.a_shortArr[41] + this.a_byteArr[6464 + this.v_int]]
                  && (this.m_byte != 16 || this.a_byteArr[6464 + this.v_int] != 12)) {
                  if (this.a_byteArr[6464 + this.v_int] != 12 && this.a_byteArr[6464 + this.v_int] != 16) {
                     this.a_byteArr[4747 + this.v_int] = 0;
                  } else {
                     this.a_void7(this.v_int, (byte)12);
                     if (!this.b_bool7(false)) {
                        this.a_void7(this.v_int, (byte)60);
                        this.a_byteArr[6464 + this.v_int] = 12;
                        this.a_byteArr[3131 + this.v_int] = this.a_byteArr[6262 + this.v_int];
                        this.a_byteArr[3232 + this.v_int] = this.a_byteArr[6363 + this.v_int];
                     }
                  }
                  ...
                  this.a_byteArr[3131 + this.v_int] = this.a_byteArr[6262 + this.v_int];
                  this.a_byteArr[3232 + this.v_int] = this.a_byteArr[6363 + this.v_int];
                  if (this.a_byteArr[505 + this.v_int] >= 30) {
                     this.g_void(1);
                  }
               }
            }

            this.a_byteArr[5050 + this.v_int] = 0;
         }

         if (this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] == this.v_int
            || this.a_byteArr[2828 + this.v_int] == 93
         ...
         this.z_int = this.a_int2(this.a_byteArr[0 + this.v_int], this.a_byteArr[101 + this.v_int], 0);
         if (this.a_byteArr[5050 + this.v_int] == 0
            && this.a_byteArr[808 + this.v_int] <= this.a_byteArr[707 + this.v_int]
            && this.z_int / 10 > this.B_int
            && this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] == this.v_int) {
   ...
   private void u_void() {
      if (this.a_byteArr[202 + this.v_int] != 0
         || this.a_byteArr[303 + this.v_int] != 0
         || this.a_byteArr[1313 + this.v_int] == -1
         || this.z_int / 10 > this.B_int && this.a_byteArr[808 + this.v_int] > 0) {
         this.a_byteArr[2929 + this.v_int] = this.b_byte3(this.v_int);
         this.E_int = 0;
         if (this.c_bool2()) {
            return;
         }

         if ((this.a_byteArr[2929 + this.v_int] & 255) <= 7 && this.E_int < 2) {
            this.D();
            if (this.a_byteArr[202 + this.v_int] == 0
               && this.a_byteArr[303 + this.v_int] == 0
               && this.a_byteArr[4545 + this.v_int] <= -111
               && this.a_byteArr[4545 + this.v_int] >= -122) {
               this.a_byteArr[2929 + this.v_int] = (byte)(-5 - (this.u_int ^ 1) * 3 * 2 - this.a_byteArr[4545 + this.v_int]);
               this.a_byteArr[3030 + this.v_int] = 0;
               this.a_byteArr[808 + this.v_int] = 0;
               this.a_byteArr[1313 + this.v_int] = 1;
      ...
      } else if ((this.a_byteArr[2929 + this.v_int] & 255) <= 7) {
         this.a_byteArr[3030 + this.v_int] = 0;
         this.a_byteArr[1111 + this.v_int] = (byte)(this.a_byteArr[1111 + this.v_int] & 15);
         this.P();
         this.a_byteArr[808 + this.v_int] = 0;
      }
   }
   ...
   private boolean c_bool2() {
      if (this.a_byteArr[202 + this.v_int] == 0 && this.a_byteArr[303 + this.v_int] == 0 && this.a_byteArr[1313 + this.v_int] != -1) {
         try {
            this.a_byteArr[606 + this.v_int] = this.b_byteArr[this.a_shortArr[4]
               + (this.a_byteArr3[0][this.v_int][this.a_byteArr[707 + this.v_int]] - this.a_byteArr[0 + this.v_int] + 1) * 3
         ...
         if (this.b_byteArr2[this.a_byteArr3[1][this.v_int][this.a_byteArr[707 + this.v_int]]][this.a_byteArr3[0][this.v_int][this.a_byteArr[707
                  + this.v_int]]]
               != 0
            && this.a_byte4(
                  this.a_byteArr3[0][this.v_int][this.a_byteArr[707 + this.v_int]],
                  this.a_byteArr3[1][this.v_int][this.a_byteArr[707 + this.v_int]],
                  0
               )
               != 0) {
            if (!this.b_bool && this.y_byte > 1) {
               if (this.a_byteArr[2828 + this.v_int] == 0 || this.a_byteArr[2828 + this.v_int] == 3) {
                  this.a_byteArr[2828 + this.v_int]++;
               }
         ...
         if (this.b_byteArr2[this.a_byteArr3[1][this.v_int][this.a_byteArr[707 + this.v_int]]][this.a_byteArr3[0][this.v_int][this.a_byteArr[707
                  + this.v_int]]]
               > this.u_int * 50
            && this.b_byteArr2[this.a_byteArr3[1][this.v_int][this.a_byteArr[707 + this.v_int]]][this.a_byteArr3[0][this.v_int][this.a_byteArr[707
                  + this.v_int]]]
               <= (this.u_int + 1) * 50) {
            this.a_void8(
               this.b_byteArr2[this.a_byteArr3[1][this.v_int][this.a_byteArr[707 + this.v_int]]][this.a_byteArr3[0][this.v_int][this.a_byteArr[707
         ...
         if (this.E_int == 0) {
            this.C_int = this.a_byteArr[0 + this.v_int] + this.b_byteArr[this.a_shortArr[1] + 0 + this.a_byteArr[606 + this.v_int]];
            this.D_int = this.a_byteArr[101 + this.v_int] + this.b_byteArr[this.a_shortArr[1] + 8 + this.a_byteArr[606 + this.v_int]];
            if (this.b_byteArr2[this.D_int][this.C_int] != 0) {
               this.a_byteArr[4545 + this.v_int] = (byte)(-this.b_byteArr2[this.D_int][this.C_int]);
            }

            this.b_byteArr2[this.D_int][this.C_int] = -128;
         }

         if ((this.a_byteArr[2929 + this.v_int] & 255) <= 7 && this.E_int < 2) {
            this.a_byteArr[707 + this.v_int]++;
         }
      }
   ...
   private void v_void() {
      try {
         ...
         if (this.a_byteArr[5959 + this.v_int] > 0
            && this.a_byteArr[3030 + this.v_int] == 0
            && this.a_byteArr[6565 + this.v_int] == 1
            && (
               this.a_byteArr[2828 + this.v_int] >= 5 && this.a_byteArr[2828 + this.v_int] <= 9
                  || this.a_byteArr[2828 + this.v_int] == 93
                  || this.a_byteArr[2828 + this.v_int] == 92
                  || this.a_byteArr[2828 + this.v_int] == 106
            )
            && (this.a_byteArr[2929 + this.v_int] & 255) > 7
            && this.a_byteArr[5858 + this.v_int] + 2 < this.a_byteArr[5959 + this.v_int]) {
            ...
            if (this.a_byteArr[3030 + this.v_int] >= this.a_obj_f.j_byteArr2[4][this.a_byteArr[2929 + this.v_int] & 255]) {
               ...
               if ((this.a_byteArr[2929 + this.v_int] & 255) > 7) {
                  ...
                  if (this.b_byteArr[this.a_shortArr[39] + this.a_byteArr[2828 + this.v_int]] == 2 && this.a_byteArr[1313 + this.v_int] == -3) {
                     if (this.a_byteArr[2828 + this.v_int] == 59
                        && this.a_byteArr[4646 + this.v_int] == 0
                        && (
   ...
   private void w() {
      this.a_byteArr[3030 + this.v_int]++;
      if (this.b_byteArr[this.a_shortArr[171] + (this.a_byteArr[2929 + this.v_int] & 255)] != -2) {
         this.a_byteArr[1111 + this.v_int] = (byte)(this.a_byteArr[1111 + this.v_int] + 16);
      }
      ...
      if (this.a_byteArr[3030 + this.v_int] == this.a_obj_f.j_byteArr2[4][this.a_byteArr[2929 + this.v_int] & 255] - 1
         ...
         if (this.a_byteArr[2828 + this.v_int] >= 5 && this.a_byteArr[2828 + this.v_int] <= 9) {
            this.a_void13(
               this.a_byteArr[0 + this.v_int],
               this.a_byteArr[101 + this.v_int],
               0,
               this.b_byteArr[this.a_shortArr[123] + this.a_byteArr[2828 + this.v_int] - 5]
            );
         } else if (this.a_byteArr[2828 + this.v_int] == 93 || this.a_byteArr[2828 + this.v_int] == 92 || this.a_byteArr[2828 + this.v_int] == 106) {
            this.a_void13(this.a_byteArr[0 + this.v_int], this.a_byteArr[101 + this.v_int], 24, 37);
         }
      }

      if (this.a_byteArr[2929 + this.v_int] == 22 && this.a_byteArr[3030 + this.v_int] == 10 && this.a_byteArr[2828 + this.v_int] <= 26) {
         if (this.a_byteArr[2828 + this.v_int] < 26) {
            this.a_shortArr2[this.u_int][23] = (short)(this.a_shortArr2[this.u_int][23] + this.a_byteArr[3636 + this.v_int]);
         }

         this.J();
      }

      if (this.a_byteArr[2929 + this.v_int] == -108 && this.a_byteArr[3030 + this.v_int] == 6) {
         this.a_byteArr[6464 + this.v_int] = 69;
      }

      if (this.a_byteArr[2929 + this.v_int] == -109 && this.a_byteArr[3030 + this.v_int] == 1) {
         this.a_byteArr[6464 + this.v_int] = this.b_byteArr[this.a_shortArr[29] + this.a_byteArr[2828 + this.v_int]];
      }
   }

   // $VF: renamed from: d () boolean
   private boolean d_bool2() {
      if (this.a_byteArr[2929 + this.v_int] == -107 || this.a_byteArr[2929 + this.v_int] == -106) {
         this.i_void(this.z_int);
         return true;
      } else if (this.a_byteArr[2929 + this.v_int] == -95) {
         this.a_byteArr[3131 + this.v_int] = this.a_byteArr[8384];
         this.a_byteArr[3232 + this.v_int] = this.a_byteArr[8445];
         this.g_void(3);
         this.p_void();
         return true;
      } else {
         if (this.z_int / 10 <= this.B_int && this.a_byteArr[2828 + this.v_int] != 85 && this.a_byteArr[2828 + this.v_int] != 80) {
            if (this.a_byteArr[6161 + this.v_int] == 1) {
               this.a_byteArr[6161 + this.v_int] = 0;
            }
         ...
         if (this.a_byteArr[2929 + this.v_int] >= 106 && this.a_byteArr[2929 + this.v_int] <= 108) {
            ...
            this.a_byteArr[4545 + this.v_int] = 0;
            if (this.a_byteArr[1919 + this.v_int] <= 0) {
               this.a_void14(19, this.a_byteArr[0 + this.v_int], this.a_byteArr[101 + this.v_int], (byte)this.v_int);
            }
   ...
   private void x() {
      this.a_byteArr[8932 + this.a_byteArr[4444 + this.v_int]]--;
      if (this.a_byteArr[8993 + this.a_byteArr[4444 + this.v_int]] == this.v_int) {
         this.a_byteArr[8993 + this.a_byteArr[4444 + this.v_int]] = this.a_byteArr[4545 + this.v_int];
      } else {
         this.x_int = this.a_byteArr[8993 + this.a_byteArr[4444 + this.v_int]];

         while (this.a_byteArr[4545 + this.x_int] != this.v_int && this.x_int != 0) {
            this.x_int = this.a_byteArr[4545 + this.x_int];
         }

         this.a_byteArr[4545 + this.x_int] = this.a_byteArr[4545 + this.v_int];
      }

      if ((this.a_byteArr[8871 + this.a_byteArr[4444 + this.v_int]] & 2) != 0 && (this.a_byteArr[7979 + this.v_int] & 4) != 0) {
         this.a_byteArr[8871 + this.a_byteArr[4444 + this.v_int]] = (byte)(this.a_byteArr[8871 + this.a_byteArr[4444 + this.v_int]] & 253);

         for (this.x_int = this.a_byteArr[8993 + this.a_byteArr[4444 + this.v_int]];
            this.a_byteArr[4545 + this.x_int] != 0;
            this.x_int = this.a_byteArr[4545 + this.x_int]
         ) {
            if ((this.a_byteArr[7979 + this.x_int] & 4) != 0
               && (this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] != 0 || this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]] != 8)) {
               this.a_byteArr[8871 + this.a_byteArr[4444 + this.v_int]] = (byte)(this.a_byteArr[8871 + this.a_byteArr[4444 + this.v_int]] | 2);
               break;
            }
         }
      }
      ...
      this.a_byteArr[4646 + this.v_int] = -1;
      this.a_byteArr[4545 + this.v_int] = 0;
      this.b_void4(this.a_byteArr[4444 + this.v_int]);
      this.a_bool4(
         1,
         127,
         this.a_byteArr[8383 + this.a_byteArr[4444 + this.v_int]]
            + this.b_byteArr[this.a_shortArr[24] + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]],
         this.a_byteArr[8444 + this.a_byteArr[4444 + this.v_int]]
            + this.b_byteArr[this.a_shortArr[25] + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]]
      );
      this.a_byteArr[0 + this.v_int] = this.a_byteArr[3131 + this.v_int];
      this.a_byteArr[101 + this.v_int] = this.a_byteArr[3232 + this.v_int];
      this.a_byteArr[202 + this.v_int] = 0;
      this.a_byteArr[303 + this.v_int] = 0;
      this.a_byteArr[606 + this.v_int] = this.b_byteArr[this.a_shortArr[111] + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]];
      this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] = (byte)this.v_int;
      this.a_byteArr[1313 + this.v_int] = 0;
      this.a_byteArr[1818 + this.v_int] = (byte)(this.a_byteArr[1818 + this.v_int] - 2);
      if (this.a_byteArr[2828 + this.v_int] == 59) {
         this.a_byteArr[6464 + this.v_int] = 69;
         this.a_byteArr[6262 + this.v_int] = this.a_byteArr[0 + this.v_int];
         this.a_byteArr[6363 + this.v_int] = this.a_byteArr[101 + this.v_int];
      ...
      if ((this.a_obj_f.p_byte & 3) == 1 && this.a_byteArr[7575 + this.v_int] > 3 && this.u_int == 0 && this.a_obj_f.q_byte < 7) {
         ...
         if (this.a_byteArr[6161 + this.v_int] < 2) {
            this.N();
         }
      }
   }
   ...
   // $VF: renamed from: e () boolean
   private boolean e_bool2() {
      if (this.b_byteArr[this.a_shortArr[39] + this.a_byteArr[2828 + this.v_int]] == 1
         && this.a_byteArr[4040 + this.v_int] > 0
         && (this.a_byteArr[2929 + this.v_int] & 255) >= 8
         && this.a_byteArr[3131 + this.v_int] == this.a_byteArr[0 + this.v_int]
         && this.a_byteArr[3232 + this.v_int] == this.a_byteArr[101 + this.v_int]) {
         if (this.c_bool3(this.a_byteArr[4444 + this.v_int])) {
            this.a_byteArr[2929 + this.v_int] = this.b_byte3(this.v_int);
            if (this.a_byteArr[8810 + this.a_byteArr[4444 + this.v_int]] != this.v_int
               || this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]] == 2 && this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] == 0) {
               this.a_byteArr[8932 + this.a_byteArr[4444 + this.v_int]]++;
            }

            this.a_byteArr[606 + this.v_int] = this.a_byteArr[4040 + this.v_int];
            this.a_byteArr[1313 + this.v_int] = -1;
            this.a_byteArr[4040 + this.v_int] = -100;
            this.a_byteArr[1111 + this.v_int] = (byte)(this.a_byteArr[1111 + this.v_int] & 240);
            this.a_byteArr[4848 + this.v_int] = 0;
         } else if (this.b_byteArr[this.a_shortArr[41] + this.a_byteArr[2828 + this.v_int]] == 0
            && this.a_byteArr[2828 + this.v_int] != 69
            && this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]] != 11) {
            if (this.a_bool8(this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]])) {
               this.g_void(1);
            }
         } else if (this.b_byteArr[this.a_shortArr[41] + this.a_byteArr[2828 + this.v_int]] != 0
            && (
         ...
         return (this.a_byteArr[2929 + this.v_int] & 255) <= 7;
      }
   }
   ...
   private void y() {
      if (this.b_byteArr[this.a_shortArr[171] + (this.a_byteArr[2929 + this.v_int] & 255)] != -2
            && (this.a_byteArr[1111 + this.v_int] & 255) >> 4 >= this.b_byteArr[this.a_shortArr[37] + this.a_byteArr[2828 + this.v_int]]
         || this.b_byteArr[this.a_shortArr[171] + (this.a_byteArr[2929 + this.v_int] & 255)] == -2 && this.d_bool) {
         this.a_byteArr[1111 + this.v_int] = (byte)(this.a_byteArr[1111 + this.v_int] & 15);
         if (this.a_byteArr[2828 + this.v_int] == 84
            && (this.a_byteArr[3939 + this.v_int] >= 28 && this.a_byteArr[3939 + this.v_int] <= 49 || this.a_byteArr[3939 + this.v_int] == 99)
            && this.b_bool5(this.a_byteArr[3939 + this.v_int] - 28, true, this.v_int)) {
            this.a_byteArr[404 + this.v_int] = 100;
         }

         if ((
               this.a_byteArr[4444 + this.v_int] >= 0 && this.z_int / 10 <= this.B_int
                  || this.a_byteArr[2828 + this.v_int] == 85
                  || this.a_byteArr[2828 + this.v_int] == 80
            )
            && this.i_bool()
            && (this.a_byteArr[2828 + this.v_int] != 69 || this.a_byteArr[6161 + this.v_int] < 2)) {
            if (this.a_byteArr[3131 + this.v_int] == this.a_byteArr[0 + this.v_int]
               && this.a_byteArr[3232 + this.v_int] == this.a_byteArr[101 + this.v_int]) {
               if (this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] != this.v_int) {
                  return;
               }
            } else {
               if (this.a_byteArr[2828 + this.v_int] == 58 || this.a_byteArr[2828 + this.v_int] == 57) {
                  this.v_int = this.a_int3(this.v_int);
               }
      ...
      if (!this.f_bool2()) {
         if (this.a_byteArr[2828 + this.v_int] != 69 || this.a_byteArr[202 + this.v_int] != 0 || this.a_byteArr[303 + this.v_int] != 0) {
            if (this.a_byteArr[2828 + this.v_int] == 84 && this.a_byteArr[3939 + this.v_int] == 69 && this.x_int < 10) {
               this.a_void7(this.v_int, (byte)85);
            }
         ...
         if (this.a_byteArr[2929 + this.v_int] == 39 || this.a_byteArr[2929 + this.v_int] == 104 || this.a_byteArr[2929 + this.v_int] == 105) {
            this.a_byteArr[3333 + this.v_int] = (byte)(11 + (this.x_int & 1));
         }
   ...
   // $VF: renamed from: f () boolean
   private boolean f_bool2() {
      if (this.a_byteArr[2828 + this.v_int] == 78 && this.a_byteArr[2929 + this.v_int] >= 113 && this.a_byteArr[2929 + this.v_int] <= 116) {
         return true;
      } else {
         if (this.a_byteArr[4646 + this.v_int] >= 0 && this.a_byteArr[1313 + this.v_int] == -2) {
            ...
            if (this.a_byteArr[2828 + this.v_int] == 51) {
               ...
               if (this.a_byteArr[1313 + this.C_int] >= 0 && this.a_byteArr[4646 + this.C_int] >= 0) {
                  this.a_byteArr[2828 + this.C_int] = 55;
               } else {
            ...
            if (this.b_byteArr[this.a_shortArr[42] + this.b_byteArr[this.a_shortArr[41] + this.a_byteArr[6464 + this.v_int]]]
                  != this.b_byteArr[this.a_shortArr[42] + this.b_byteArr[this.a_shortArr[41] + this.a_byteArr[2828 + this.v_int]]]
               && this.b_byteArr[this.a_shortArr[42] + this.b_byteArr[this.a_shortArr[41] + this.a_byteArr[2828 + this.v_int]]] > 0) {
               this.a_byteArr[2929 + this.v_int] = -109;
               this.a_byteArr[1313 + this.v_int] = (byte)(this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] != 0
                  ? 50
                  : (this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]] == 7 ? 51 : 1));
               return true;
            }

            if (this.a_byteArr[8810 + this.a_byteArr[4444 + this.v_int]] == this.v_int
               && (this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]] >= 12 || this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] != 0)
               && this.a_byteArr[3636 + this.v_int] == 9) {
               if (this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]] >= 12) {
                  this.v_byte = 0;

                  while (this.v_byte < 10 && this.f_byteArr2[0][this.v_byte] != this.a_byteArr[4444 + this.v_int]) {
                     this.v_byte++;
                  }

                  this.f_byteArr2[1][this.v_byte]++;
               } else {
                  this.v_byte = 0;

                  while (this.v_byte < 20 && this.g_byteArr2[0][this.v_byte] != this.a_byteArr[4444 + this.v_int]) {
                     this.v_byte++;
                  }

                  this.g_byteArr2[2][this.v_byte] = (byte)(this.g_byteArr2[2][this.v_byte] * -1);
               }

               this.a_byteArr[3636 + this.v_int] = 0;
               this.a_byteArr[3535 + this.v_int] = 0;
               this.a_byteArr[1313 + this.v_int] = (byte)(this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] != 0 ? 50 : 1);
               this.a_byteArr[2929 + this.v_int] = -102;
               return true;
            }
         }
   ...
   private boolean b_bool3(int var1) {
      if ((
         ...
         this.a_byteArr[4848 + this.v_int] = 0;
         this.H_int = this.a_byteArr[2828 + this.v_int];
      }

      if (this.H_int == 13) {
         if ((this.a_byteArr[2929 + this.v_int] & 255) < 141) {
            this.a_byteArr[2929 + this.v_int] = -111;
            this.a_byteArr[606 + this.v_int] = (byte)(
               this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int] + 1] <= -61
                     && this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int] + 1] >= -110
                  ? 0
                  : 4
            );
            return true;
         ...
         if (this.a_byteArr[2929 + this.v_int] == -110) {
            return true;
         }
      }

      if ((this.a_byteArr[2929 + this.v_int] == -101 || this.a_byteArr[2929 + this.v_int] == -100) && this.x_int > 20) {
         this.z();
      } else if (this.H_int == 69 && (this.a_byteArr[7979 + this.v_int] & 2) == 0 && this.x_int > 98 && this.g_bool2()) {
         return true;
      }

      if (this.H_int == 72) {
         this.y_int = this.b_byteArr[this.a_shortArr[158] + this.b_byteArr[this.a_shortArr[77] + this.a_byteArr[6565 + this.v_int]]];
      } else if (this.H_int == 69 && (this.a_byteArr[7979 + this.v_int] & 2) > 0) {
         this.y_int = 6;
      } else if ((this.H_int == 69 || this.H_int == 109 || this.H_int == 60 || this.H_int == 51 || this.H_int == 87)
         && (this.a_byteArr[3535 + this.v_int] != 0 || this.a_byteArr[6565 + this.v_int] == 1)) {
         this.y_int = this.H_int == 60 ? 1 : (this.H_int != 51 && this.H_int != 87 ? 4 : 2);
      } else if (this.H_int == 83 || this.H_int == 85 || this.H_int == 105) {
         this.y_int = this.a_byteArr[1313 + this.v_int];
      } else if (this.H_int == 84) {
         this.y_int = this.b_byteArr[this.a_shortArr[167] + this.a_byteArr[1313 + this.v_int]];
      } else {
         this.y_int = 0;
      }

      for (this.y_int = this.y_int + (this.b_byteArr[this.a_shortArr[166] + this.H_int] & 255);
         this.y_int < (this.b_byteArr[this.a_shortArr[166] + this.H_int + 1] & 255);
         this.y_int++
      ) {
         if (this.b_byteArr[this.a_shortArr[165] + this.y_int] > this.x_int) {
            this.a_byteArr[2929 + this.v_int] = this.b_byteArr[this.a_shortArr[164] + this.y_int];
            if (this.a_byteArr[4646 + this.v_int] < 0
               || this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]] != 2
               || this.a_byteArr[1313 + this.v_int] <= 0) {
               if ((this.b_byteArr[this.a_shortArr[171] + (this.a_byteArr[2929 + this.v_int] & 255)] & 254) != 254 && this.x_int >= 85) {
                  this.a_byteArr[2929 + this.v_int] = this.b_byteArr[this.a_shortArr[171] + (this.a_byteArr[2929 + this.v_int] & 255)];
               }

               if (this.a_byteArr[4646 + this.v_int] >= 0) {
                  this.a_byteArr[1313 + this.v_int] = (
                           this.a_byteArr[2828 + this.v_int]
                                 == this.b_byteArr[this.a_shortArr[58]
                                    + this.b_byteArr[this.a_shortArr[174] + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]]
                                    + this.a_byteArr[4646 + this.v_int]]
                              || this.a_byteArr[2828 + this.v_int] == 53
                              || this.a_byteArr[2828 + this.v_int] == 111
                              || this.a_byteArr[4646 + this.v_int] > 0 && this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]] < 12
                        )
                        && this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] == 0
                     ? (byte)(this.y_int - (this.b_byteArr[this.a_shortArr[166] + this.H_int] & 255))
                     : 50;
               }
            }
            break;
         ...
         for (this.D_int = this.a_byteArr[101 + this.v_int] - 1; this.D_int < this.a_byteArr[101 + this.v_int] + 2; this.D_int++) {
            if (this.C_int > 0 && this.C_int < this.a_obj_f.c_short - 1 && this.D_int > 0 && this.D_int < this.a_obj_f.d_short - 1) {
               ...
               if (this.y_int > this.u_int * 50
                  ...
                  && (
                     this.a_byteArr[2929 + this.y_int] == 8
                        || this.a_byteArr[2929 + this.y_int] == 9
                        || this.a_byteArr[2929 + this.y_int] >= 15 && this.a_byteArr[2929 + this.y_int] <= 18
                  )) {
                  this.a_byteArr[2929 + this.v_int] = (byte)(this.a_byteArr[3535 + this.v_int] == 0 && this.a_byteArr[6565 + this.v_int] != 1
                     ? -101
                     : -100);
                  this.a_byteArr[606 + this.v_int] = (byte)(
                     this.b_byteArr[this.a_shortArr[53]
                           + (12 + this.D_int - this.a_byteArr[101 + this.v_int]) * 25
                           + 12
                           + this.C_int
                           - this.a_byteArr[0 + this.v_int]]
                        % 10
                  );
                  this.a_byteArr[606 + this.y_int] = (byte)(this.a_byteArr[606 + this.v_int] + 4 & 7);
                  this.a_byteArr[4646 + this.v_int] = (byte)(-92 - this.b_byteArr[this.a_shortArr[99] + 8 + this.a_byteArr[606 + this.v_int]]);
                  return true;
               }
            }
         }
   ...
   private void z() {
      this.y_int = this.b_byteArr2[this.a_byteArr[101 + this.v_int] + this.b_byteArr[this.a_shortArr[1] + 8 + this.a_byteArr[606 + this.v_int]]][this.a_byteArr[0
            + this.v_int]
         + this.b_byteArr[this.a_shortArr[1] + this.a_byteArr[606 + this.v_int]]];
      if (this.y_int > this.u_int * 50
         && this.y_int <= (this.u_int + 1) * 50
         && (
            this.a_byteArr[2929 + this.y_int] == 8
         ...
         this.a_byteArr[2929 + this.y_int] = (byte)(this.a_byteArr[3535 + this.y_int] == 0 && this.a_byteArr[6565 + this.y_int] != 1 ? -101 : -100);
         this.a_byteArr[606 + this.y_int] = (byte)(this.a_byteArr[606 + this.v_int] + 4 & 7);
         this.a_byteArr[3030 + this.y_int] = (byte)(this.y_int < this.v_int ? 0 : -1);
         this.a_byteArr[4646 + this.y_int] = (byte)(-92 - this.b_byteArr[this.a_shortArr[99] + 8 + this.a_byteArr[606 + this.y_int]]);
      }
   }
      ...
      if (this.a_byteArr[4646 + this.v_int] < 0
         || this.a_byteArr[2929 + this.v_int]
               != this.b_byteArr[this.a_shortArr[173]
                  ...
                  + this.a_byteArr[4646 + this.v_int]]
            && this.a_byteArr[2929 + this.v_int]
               != this.b_byteArr[this.a_shortArr[176]
                  + this.b_byteArr[this.a_shortArr[177] + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]]
                  + this.a_byteArr[4646 + this.v_int]]) {
         if (this.a_byteArr[2828 + this.v_int] == 79
            ...
            if (this.a_byteArr[2828 + this.v_int] != 83 && this.a_byteArr[2828 + this.v_int] != 84) {
               ...
               this.a_void7(this.v_int, (byte)80);
            } else {
               this.a_void7(this.v_int, (byte)85);
            }
      ...
      if (this.a_byteArr[2929 + this.v_int] == -106 || this.a_byteArr[2929 + this.v_int] == -107) {
         ...
         if (this.a_byteArr[3030 + this.v_int] < this.a_obj_f.j_byteArr2[4][this.a_byteArr[2929 + this.v_int] & 255]) {
            ...
            if (this.a_byteArr[2929 + this.v_int] == -107) {
               this.a_byteArr[7979 + this.v_int] = (byte)(this.a_byteArr[7979 + this.v_int] | 2);
            }
         ...
         && this.a_byteArr[6464 + this.v_int] == 69
         && this.a_byteArr[7777 + this.v_int] == 0
         && (this.a_byteArr[7979 + this.v_int] & 3) == 1) {
         this.a_byteArr[2929 + this.v_int] = -107;
         this.a_byteArr[3030 + this.v_int] = 0;
         return true;
      } else if ((this.a_byteArr[7979 + this.v_int] & 2) == 0
         || (this.a_byteArr[2828 + this.v_int] == 69 || this.a_byteArr[2828 + this.v_int] == 105)
            && (this.a_byteArr[7979 + this.v_int] & 1) != 0
            && this.a_byteArr[7777 + this.v_int] <= 0) {
         return false;
      } else {
         this.a_byteArr[2929 + this.v_int] = -106;
         this.a_byteArr[3030 + this.v_int] = 0;
         this.a_byteArr[7979 + this.v_int] = (byte)(this.a_byteArr[7979 + this.v_int] & 253);
         return true;
      }
   }
   ...
   // $VF: renamed from: A () void
   private void A() {
      this.a_byteArr[2222 + this.v_int] = this.b_byteArr[this.a_shortArr[41] + this.a_byteArr[6464 + this.v_int]];

      for (this.I_int = 0; this.I_int < 4; this.I_int++) {
         this.a_byteArr[this.b_shortArr[23 + this.I_int] + this.v_int] = (byte)(9 + (this.I_int >> 1));
      }

      for (this.I_int = 2; this.I_int >= 0; this.I_int--) {
         for (this.J_int = 25; this.J_int <= 26; this.J_int++) {
            if (this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[107] + this.a_byteArr[this.b_shortArr[this.J_int] + this.v_int]]] + this.v_int]
               <= this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[107] + this.I_int]] + this.v_int]) {
               for (this.K_int = 26; this.K_int > this.J_int; this.K_int--) {
                  this.a_byteArr[this.b_shortArr[this.K_int] + this.v_int] = this.a_byteArr[this.b_shortArr[this.K_int - 1] + this.v_int];
               }

               this.a_byteArr[this.b_shortArr[this.J_int] + this.v_int] = (byte)this.I_int;
               break;
            }
         }
      }

      this.a_byteArr[1818 + this.v_int] = (byte)b_int2(this.a_byteArr[1818 + this.v_int], 3 + this.a_byteArr[1616 + this.v_int] / 2, 7);
      this.a_byteArr[4949 + this.v_int] = (byte)b_int2(this.a_byteArr[4949 + this.v_int], this.a_byteArr[1818 + this.v_int] + 1, 9);

      for (this.I_int = 3; this.I_int < 9; this.I_int++) {
         for (this.J_int = 23; this.J_int <= 24; this.J_int++) {
            if (this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[107] + this.a_byteArr[this.b_shortArr[this.J_int] + this.v_int]]] + this.v_int]
               < this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[107] + this.I_int]] + this.v_int]) {
               if (this.I_int == this.a_byteArr[2525 + this.v_int]
                  || this.I_int == this.a_byteArr[2626 + this.v_int]
                  || this.b_byteArr[this.a_shortArr[108] + this.I_int]
                     == (this.a_byteArr[2222 + this.v_int] < 8 && this.a_byteArr[2222 + this.v_int] > 0 ? 7 : this.a_byteArr[2222 + this.v_int])) {
                  break;
               }

               for (this.K_int = 24; this.K_int > this.J_int; this.K_int--) {
                  this.a_byteArr[this.b_shortArr[this.K_int] + this.v_int] = this.a_byteArr[this.b_shortArr[this.K_int - 1] + this.v_int];
               }
      ...
      for (this.J_int = 23; this.J_int <= 26; this.J_int++) {
         if (this.a_byteArr[this.b_shortArr[this.J_int] + this.v_int] > 8) {
            this.a_byteArr[this.b_shortArr[this.J_int] + this.v_int] = -1;
         } else {
            this.a_byteArr[this.b_shortArr[this.J_int] + this.v_int] = this.b_byteArr[this.a_shortArr[108]
               + this.a_byteArr[this.b_shortArr[this.J_int] + this.v_int]];
         }
      }
   }
   ...
   private void B() {
      if (this.a_byteArr[2929 + this.v_int] != 39 && this.a_byteArr[2929 + this.v_int] != 104 && this.a_byteArr[2929 + this.v_int] != 105) {
         ...
         if (this.a_byteArr[3333 + this.v_int] >= -1 && this.a_byteArr[2828 + this.v_int] > 9) {
            if (this.a_byteArr[2828 + this.v_int] >= 109 && this.a_byteArr[2828 + this.v_int] <= 111) {
               ...
               if (this.a_byteArr[3434 + this.v_int] < 1 && this.a_byteArr[505 + this.v_int] < 10) {
                  this.a_byteArr[3333 + this.v_int] = 9;
               }

               if (this.a_byteArr[2020 + this.v_int] == 0) {
                  this.a_byteArr[3333 + this.v_int] = 0;
               }

               if (this.a_byteArr[2121 + this.v_int] == 0) {
                  this.a_byteArr[3333 + this.v_int] = 2;
               }
            }
         }
      }
   ...
   private void C() {
      if (this.a_byteArr[2828 + this.v_int] != 78 || this.a_byteArr[2929 + this.v_int] < 113 || this.a_byteArr[2929 + this.v_int] > 116) {
         if (this.b_byteArr[this.a_shortArr[40] + this.a_byteArr[2828 + this.v_int]] != -1) {
            if (this.a_byteArr[3535 + this.v_int] != this.b_byteArr[this.a_shortArr[40] + this.a_byteArr[2828 + this.v_int]]) {
               this.a_byteArr[3636 + this.v_int] = 0;
               this.a_byteArr[3535 + this.v_int] = this.b_byteArr[this.a_shortArr[40] + this.a_byteArr[2828 + this.v_int]];
               return;
            }
         } else if (this.a_byteArr[3636 + this.v_int] == 0) {
            this.a_byteArr[3535 + this.v_int] = 0;
         }
      }
   }
   ...
   private void a_void8(byte var1) {
      ...
      this.v_int = this.u_byte;
   }

   // $VF: renamed from: D () void
   private void D() {
      this.E();
      if ((this.a_byteArr[1111 + this.v_int] & 15) == (this.b_byteArr[this.a_shortArr[15] + this.w_int * 9 + this.L_int] + 1) / 2
         && this.a_byteArr[4848 + this.v_int] != 120) {
         this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] = 0;
         if (this.a_byteArr[4545 + this.v_int] <= -111) {
            this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] = this.a_byteArr[4545 + this.v_int];
            this.a_byteArr[4545 + this.v_int] = 0;
         }

         if (this.a_byteArr[4545 + this.v_int] >= 111) {
            this.a_byteArr[4545 + this.v_int] = (byte)(this.a_byteArr[4545 + this.v_int] * -1);
            this.a_byteArr[1313 + this.v_int] = 0;
         }

         if (this.a_byteArr[1313 + this.v_int] == -1) {
            this.F();
            return;
         }

         this.a_byteArr[0 + this.v_int] = (byte)(
            this.a_byteArr[0 + this.v_int] + this.b_byteArr[this.a_shortArr[1] + 0 + this.a_byteArr[606 + this.v_int]]
         );
         this.a_byteArr[101 + this.v_int] = (byte)(
            this.a_byteArr[101 + this.v_int] + this.b_byteArr[this.a_shortArr[1] + 8 + this.a_byteArr[606 + this.v_int]]
         );
         this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] = (byte)this.v_int;
      }

      if (this.a_byteArr[4848 + this.v_int] == 120) {
         if ((this.a_byteArr[1111 + this.v_int] & 15) < (this.b_byteArr[this.a_shortArr[15] + this.w_int * 9 + this.L_int] + 1) / 2) {
            this.a_byteArr[202 + this.v_int] = (byte)(
               this.a_byteArr[202 + this.v_int] - this.b_byteArr[this.a_shortArr[1] + 0 + this.a_byteArr[606 + this.v_int]] * 22
            );
            this.a_byteArr[303 + this.v_int] = (byte)(
               this.a_byteArr[303 + this.v_int] - this.b_byteArr[this.a_shortArr[1] + 8 + this.a_byteArr[606 + this.v_int]] * 16
            );
         }

         this.a_byteArr[202 + this.v_int] = (byte)(
            this.a_byteArr[202 + this.v_int]
               + this.b_byteArr[this.a_shortArr[9 + this.w_int]
                     + this.b_byteArr[this.a_shortArr[12 + this.w_int * 2] + this.L_int]
                     + (this.a_byteArr[1111 + this.v_int] & 15)]
                  * this.b_byteArr[this.a_shortArr[2] + 0 + this.a_byteArr[606 + this.v_int]]
         );
         this.a_byteArr[303 + this.v_int] = (byte)(
            this.a_byteArr[303 + this.v_int]
               + this.b_byteArr[this.a_shortArr[11 + this.w_int * 2]
                     + this.b_byteArr[this.a_shortArr[12 + this.w_int * 2] + this.L_int]
                     + (this.a_byteArr[1111 + this.v_int] & 15)]
                  * this.b_byteArr[this.a_shortArr[2] + 8 + this.a_byteArr[606 + this.v_int]]
         );
      }
   }
   ...
   // $VF: renamed from: E () void
   private void E() {
      this.w_int = this.a_byteArr[606 + this.v_int] & 1;
      this.L_int = this.a_byteArr[1010 + this.v_int] - this.a_byteArr[7777 + this.v_int];
      this.a_byteArr[1111 + this.v_int]++;
      this.a_byteArr[202 + this.v_int] = this.b_byteArr[this.a_shortArr[5 + this.w_int]
         + this.b_byteArr[this.a_shortArr[12 + this.w_int * 2] + this.L_int]
         + (
               this.b_byteArr[this.a_shortArr[15] + this.w_int * 9 + this.L_int]
                  + (this.a_byteArr[1111 + this.v_int] & 15) * this.b_byteArr[this.a_shortArr[1] + 0 + this.a_byteArr[606 + this.v_int]]
            )
            % this.b_byteArr[this.a_shortArr[15] + this.w_int * 9 + this.L_int]];
      this.a_byteArr[303 + this.v_int] = this.b_byteArr[this.a_shortArr[7 + this.w_int]
         + this.b_byteArr[this.a_shortArr[12 + this.w_int * 2] + this.L_int]
         + (
               this.b_byteArr[this.a_shortArr[15] + this.w_int * 9 + this.L_int]
                  + (this.a_byteArr[1111 + this.v_int] & 15) * this.b_byteArr[this.a_shortArr[1] + 8 + this.a_byteArr[606 + this.v_int]]
            )
            % this.b_byteArr[this.a_shortArr[15] + this.w_int * 9 + this.L_int]];
      if (this.a_byteArr[202 + this.v_int] == 0 && this.a_byteArr[303 + this.v_int] == 0 && this.a_byteArr[4848 + this.v_int] == 120) {
         this.a_byteArr[4848 + this.v_int] = 1;
      }

      if ((this.a_byteArr[1111 + this.v_int] & 15) == (this.b_byteArr[this.a_shortArr[15] + this.w_int * 9 + this.L_int] + 1) / 2) {
         if ((this.b_byteArr[this.a_shortArr[15] + this.w_int * 9 + this.L_int] & 1) == 0
            && this.b_byteArr[this.a_shortArr[1] + 0 + this.a_byteArr[606 + this.v_int]] < 0) {
            this.a_byteArr[202 + this.v_int] = (byte)(this.a_byteArr[202 + this.v_int] + 22);
         }

         if ((this.b_byteArr[this.a_shortArr[15] + this.w_int * 9 + this.L_int] & 1) == 0
            && this.b_byteArr[this.a_shortArr[1] + 8 + this.a_byteArr[606 + this.v_int]] < 0) {
            this.a_byteArr[303 + this.v_int] = (byte)(this.a_byteArr[303 + this.v_int] + 16);
         }
      }
   }
   ...
   private void F() {
      ...
      if (this.a_byteArr[6161 + this.v_int] <= 1
         ...
         this.a_byteArr[3131 + this.v_int] = this.a_byteArr[0 + this.v_int];
         this.a_byteArr[3232 + this.v_int] = this.a_byteArr[101 + this.v_int];
         this.a_byteArr[1313 + this.v_int] = -2;
         this.a_byteArr[1818 + this.v_int] = (byte)(this.a_byteArr[1818 + this.v_int] + 2);
         this.G();
         this.a_byteArr[4545 + this.v_int] = this.a_byteArr[8993 + this.a_byteArr[4444 + this.v_int]];
         this.a_byteArr[8993 + this.a_byteArr[4444 + this.v_int]] = (byte)this.v_int;
         this.b_void4(this.a_byteArr[4444 + this.v_int]);
         if ((this.b_byteArr[this.a_shortArr[27] + this.a_byteArr[2828 + this.v_int]] & 128) == 0) {
            this.a_void7(
               this.v_int,
               this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] == 0
                  ? this.b_byteArr[this.a_shortArr[57]
                     + this.b_byteArr[this.a_shortArr[174] + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]]
                     + this.a_byteArr[4646 + this.v_int]]
                  : this.b_byteArr[this.a_shortArr[59]
                     + this.b_byteArr[this.a_shortArr[177] + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]]
                     + this.a_byteArr[4646 + this.v_int]]
            );
         }

         if (this.a_byteArr[4646 + this.v_int] == this.b_byteArr[this.a_shortArr[138] + 156 + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]]
            || this.b_byteArr[this.a_shortArr[138] + 156 + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]] < 0
               && this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]] != 2
               && this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]] != 3
            || this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]] >= 12
            || this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] != 0) {
            if (this.b_byteArr[this.a_shortArr[42]
                     + this.b_byteArr[this.a_shortArr[41]
                        + this.b_byteArr[this.a_shortArr[16] + this.b_byteArr[this.a_shortArr[17] + 2] + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]]]]
                  == 0
               && this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] == 0) {
               this.a_byteArr[6464 + this.v_int] = this.b_byteArr[this.a_shortArr[16]
                  + this.b_byteArr[this.a_shortArr[17] + 2]
                  + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]];
            }

            this.a_byteArr[6262 + this.v_int] = this.a_byteArr[8383 + this.a_byteArr[4444 + this.v_int]];
            this.a_byteArr[6363 + this.v_int] = this.a_byteArr[8444 + this.a_byteArr[4444 + this.v_int]];
         }
         ...
         this.a_byteArr[2929 + this.v_int] = this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] == 0
            ? this.b_byteArr[this.a_shortArr[172]
               + this.b_byteArr[this.a_shortArr[174] + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]]
               + this.a_byteArr[4646 + this.v_int]]
            : this.b_byteArr[this.a_shortArr[175]
               + this.b_byteArr[this.a_shortArr[177] + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]]
               + this.a_byteArr[4646 + this.v_int]];
      } else {
         if (this.a_byteArr[6161 + this.v_int] == 1) {
   ...
   private void G() {
      this.x_byte = this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]];
      this.v_byte = this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] == 0 ? this.b_byteArr[this.a_shortArr[138] + 156 + this.x_byte] : 0;
      this.w_byte = this.a_byteArr[8932 + this.a_byteArr[4444 + this.v_int]];

      for (this.x_int = 0; this.x_int < 8; this.x_int++) {
         this.i_byteArr[this.x_int] = 0;
      }
      ...
      for (this.x_int = this.a_byteArr[8993 + this.a_byteArr[4444 + this.v_int]];
         ...
         this.i_byteArr[this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] == 0
            ? this.a_byteArr[4646 + this.x_int]
            : this.b_byteArr[this.a_shortArr[93] + this.b_byteArr[this.a_shortArr[94] + this.x_byte] + this.a_byteArr[4646 + this.x_int]]] = (byte)this.x_int;
      }

      if (this.v_byte >= 0 && this.i_byteArr[0] == 0) {
         if (this.a_byteArr[8810 + this.a_byteArr[4444 + this.v_int]] <= 0 || this.a_byteArr[8810 + this.a_byteArr[4444 + this.v_int]] == this.v_int) {
            if (this.a_byteArr[8810 + this.a_byteArr[4444 + this.v_int]] == this.v_int) {
               this.a_byteArr[8932 + this.a_byteArr[4444 + this.v_int]]++;
            }

            this.a_byteArr[4646 + this.v_int] = this.v_byte;
            this.a_byteArr[8810 + this.a_byteArr[4444 + this.v_int]] = (byte)this.v_int;
            return;
         }

         this.i_byteArr[this.v_byte] = this.a_byteArr[8810 + this.a_byteArr[4444 + this.v_int]];
         if (this.a_byteArr[4646 + this.i_byteArr[this.v_byte]] < 0
            || this.a_byteArr[4444 + this.i_byteArr[this.v_byte]] != this.a_byteArr[4444 + this.v_int]) {
            this.w_byte++;
         }
      }
      ...
      this.a_byteArr[4646 + this.v_int] = (byte)(
         this.a_obj_f
               .a_int2(
                  ...
                  (
                        this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] == 0
                           ? this.b_byteArr[this.a_shortArr[138] + (this.a_byteArr[9115 + this.a_byteArr[4444 + this.v_int]] - 1) * 26 + this.x_byte]
                           : this.b_byteArr[this.a_shortArr[138] + 494 + this.x_byte]
                     )
                     - this.w_byte
                     + 1
               )
      ...
      if (this.x_byte == 2 && this.i_byteArr[0] == 0) {
         this.a_byteArr[4646 + this.v_int] = 0;
      } else {
         this.x_int = 0;
         ...
         for (this.y_int = 0;
            ...
            if (this.i_byteArr[this.x_int] == 0) {
               this.y_int++;
            }

            if (this.a_byteArr[4646 + this.v_int] == this.y_int) {
               this.a_byteArr[4646 + this.v_int] = (byte)this.x_int;
               break;
            }
         }

         if (this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] != 0) {
            this.a_byteArr[4646 + this.v_int] = this.b_byteArr[this.a_shortArr[95]
               + this.b_byteArr[this.a_shortArr[96] + this.x_byte]
               + this.a_byteArr[4646 + this.v_int]];
         }
      }
   }
                        ...
                        if (this.B_byte > var9 * 50 && this.B_byte <= (var9 + 1) * 50) {
                           if (this.a_byteArr[1919 + this.B_byte] > 0
                              && (
                                 (this.a_byteArr[7979 + this.v_int] & 2) > 0
                                       && 1
                                             + (10 - this.a_byteArr[7575 + this.v_int]) / 3
                                             + this.a_byteArr[7575 + this.B_byte] / (this.a_byteArr[7575 + this.v_int] - 3)
                                          >= this.C_byte
                                    || (this.a_byteArr[7979 + this.v_int] & 2) == 0 && this.a_byteArr[4949 + this.B_byte] >= this.C_byte
                              )) {
                           ...
                           if (this.a_byteArr[8505 + -this.B_byte] > 0
                              ...
                              && (
                                 (this.a_byteArr[7979 + this.v_int] & 2) > 0
                                       && 1
                                             + (10 - this.a_byteArr[7575 + this.v_int]) / 3
                                             + (this.a_byteArr[8688 + -this.B_byte] >> 4) / (this.a_byteArr[7575 + this.v_int] - 3)
                                          >= this.C_byte
                                    || (this.a_byteArr[7979 + this.v_int] & 2) == 0 && (this.a_byteArr[8688 + -this.B_byte] & 15) >= this.C_byte
                              )) {
                              this.a_byteArr[7979 + this.v_int] = (byte)(this.a_byteArr[7979 + this.v_int] & 254);
                              return true;
                           }
                        } else if (-this.B_byte >= 111 + 6 * (this.u_int ^ 1)
   ...
   private void H() {
      ...
      if ((this.I_byte & this.u_int + 1) == 0
         || this.f_byte < 50
            && (
               this.y_byte == 2
                  ...
                  || this.A_byte > this.b_byteArr[this.P_int + 3]
            )) {
         this.B_byte = this.b_byteArr2[this.A_byte][this.z_byte];
         if (!this.a_bool) {
            if (this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] != this.v_int
               && this.a_byteArr[1313 + this.v_int] > 0) {
               this.a_byteArr[2828 + this.v_int] = 87;
            ...
            this.f_bool = this.a_byteArr[6565 + this.v_int] != 9
               ...
               || this.a_byteArr[0 + this.v_int] - this.a_byteArr[8384] >= -6
                  && this.a_byteArr[0 + this.v_int] - this.a_byteArr[8384] <= 6
                  && this.a_byteArr[101 + this.v_int] - this.a_byteArr[8445] >= -6
                  && this.a_byteArr[101 + this.v_int] - this.a_byteArr[8445] <= 6;
            if ((this.f_bool || this.a_byteArr[2828 + this.v_int] != 59)
               && (this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] == this.v_int || this.y_byte != 1)) {
               this.a_byteArr[3131 + this.v_int] = this.f_bool ? this.z_byte : this.a_byteArr[0 + this.v_int];
               this.a_byteArr[3232 + this.v_int] = this.f_bool ? this.A_byte : this.a_byteArr[101 + this.v_int];
               if (this.f_bool) {
                  if (this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] == this.v_int) {
                     this.g_void(1);
                     if ((this.z_int = this.a_int2(this.a_byteArr[0 + this.v_int], this.a_byteArr[101 + this.v_int], 0)) / 10 > this.B_int) {
                        this.p_void();
                     }
                  } else {
                     if (this.a_byteArr[2828 + this.v_int] <= 82) {
                        this.a_byteArr[0 + this.v_int] = this.a_byteArr[8383 + this.a_byteArr[4444 + this.v_int]];
                        this.a_byteArr[101 + this.v_int] = this.a_byteArr[8444 + this.a_byteArr[4444 + this.v_int]];
                     }

                     this.a_byteArr[4747 + this.v_int] = this.B_byte;
                     this.a_byteArr[4444 + this.v_int] = (byte)(
                        this.B_byte * this.b_byteArr[this.a_shortArr[62] + this.y_byte] - (this.y_byte == 2 ? 101 : 0)
                     );
                     this.a_void7(this.v_int, this.b_byteArr[this.a_shortArr[61] + this.y_byte]);
                     this.z_int = this.a_int2(this.a_byteArr[0 + this.v_int], this.a_byteArr[101 + this.v_int], 0);
                     this.i_void(this.z_int);
                     this.a_byteArr[3030 + this.v_int] = 0;
                     this.a_byteArr[1313 + this.v_int] = 1;
                  ...
                  this.a_byteArr[2929 + this.v_int] = -95;
                  this.a_byteArr[3030 + this.v_int] = 0;
                  this.a_byteArr[3636 + this.v_int] = 0;
                  this.a_byteArr[808 + this.v_int] = 0;
               }
         ...
         if (this.y_byte == 4 && this.u_int == 0) {
            if ((this.a_byteArr[7979 + this.v_int] & 2) == 0) {
               this.a_void19((byte)4, this.v_int, this.B_byte);
            }
         ...
         this.D_byte = this.F_byte;
         if ((this.y_byte == 4 || this.y_byte == 2 && (this.a_byteArr[7979 + this.v_int] & 128) != 0)
            && (this.a_byteArr[7979 + this.v_int] & 2) == 0) {
            this.a_void11(this.a_byteArr[0 + this.v_int], this.a_byteArr[101 + this.v_int], this.a_byteArr[4949 + this.v_int]);
         }
      } else if (this.y_byte == 4) {
         if (this.a_byteArr[4646 + this.v_int] < 0) {
            this.a_void15(this.v_int, false);
   ...
   private void c_void2(boolean var1) {
      ...
      this.c_void3(this.a_shortArr2[0][17], 0);

      for (this.N_int = 1; this.N_int < 4; this.N_int++) {
         this.e_byteArr2[this.N_int][0] = this.e_byteArr2[this.N_int][1] = 0;
      }

      for (this.O_int = 1; this.O_int <= 50; this.O_int++) {
         if (this.a_byteArr[1919 + this.O_int] > 0 && this.a_shortArr2[0][17] != this.O_int && this.a_byteArr[1414 + this.O_int] >= 12) {
      ...
      this.a_byteArr[8933] = this.G_byte;
   }
   ...
   // $VF: renamed from: f () void
   final void f_void2() {
      this.a_byteArr[8933] = this.H_byte;

      for (this.O_int = this.G_byte - 1; this.O_int >= 0; this.O_int--) {
         for (this.N_int = 1; this.N_int < 8; this.N_int++) {
            this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[186] + this.N_int]] + this.e_byteArr2[this.O_int][0]] = this.e_byteArr2[this.O_int][this.N_int];
         }
      }

      this.a_byteArr[8994] = (byte)(this.H_byte > 0 ? this.a_shortArr2[0][17] : 0);
   }

   // $VF: renamed from: i () boolean
   private boolean i_bool() {
      if ((this.a_byteArr[2929 + this.v_int] & 255) < 8
         || (this.a_byteArr[2929 + this.v_int] & 255) > 14
         || this.a_byteArr[2828 + this.v_int] == 60
         || this.a_byteArr[2828 + this.v_int] == 87) {
         this.f_bool = false;
         if (this.a_byteArr[2828 + this.v_int] > 9 && !this.l_bool()) {
            return false;
         }

         if ((this.a_byteArr[2828 + this.v_int] < 28 || this.a_byteArr[2828 + this.v_int] > 49) && this.a_byteArr[2828 + this.v_int] != 99) {
            this.J();
            if (this.a_byteArr[2929 + this.v_int] == 117) {
               this.j_void(0);
            }

            if (this.a_byteArr[4646 + this.v_int] >= 0) {
               if ((this.b_byteArr[this.a_shortArr[70] + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]] & 2) > 0
                  && this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] == 0
                  && (
                     this.a_byteArr[8810 + this.a_byteArr[4444 + this.v_int]] == this.v_int
                        || (this.b_byteArr[this.a_shortArr[70] + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]] & 1) > 0
                  )
                  && this.a_byteArr[1313 + this.v_int] > 0) {
                  this.f_bool = this.b_bool4(
                     this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]], this.a_byteArr[9115 + this.a_byteArr[4444 + this.v_int]] - 1
                  );
               }
            } else if ((this.b_byteArr[this.a_shortArr[48] + this.a_byteArr[2828 + this.v_int]] & 2) > 0) {
               this.a_bool6(
                  this.b_byteArr[this.a_shortArr[45] + this.a_byteArr[2828 + this.v_int]],
                  this.b_byteArr[this.a_shortArr[46] + this.a_byteArr[2828 + this.v_int]],
                  this.b_byteArr[this.a_shortArr[47] + this.a_byteArr[2828 + this.v_int]],
                  this.b_byteArr[this.a_shortArr[64] + this.b_byteArr[this.a_shortArr[45] + this.a_byteArr[2828 + this.v_int]]]
               );
            }
            ...
            if (this.a_byteArr[2828 + this.v_int] == 84 && this.a_byteArr[404 + this.v_int] == 100) {
               this.f_bool = true;
            }

            if (this.a_byteArr[2828 + this.v_int] == 70 || this.a_byteArr[2828 + this.v_int] == 71) {
               this.S_int = (this.a_byteArr[6767 + this.v_int] + 12) / 12;
               if (this.a_byteArr[2020 + this.v_int] % (100 / this.S_int) <= 4) {
                  this.a_shortArr2[this.u_int][0]--;
               }
            }

            if (this.R_int * this.A_int >= this.b_byteArr[this.a_shortArr[30] + this.a_byteArr[2828 + this.v_int]] * this.A_int) {
               if (this.b_byteArr[this.a_shortArr[31] + this.a_byteArr[2828 + this.v_int]] > 0 && this.a_byteArr[2828 + this.v_int] > 9) {
                  this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[31] + this.a_byteArr[2828 + this.v_int]]] + this.a_byteArr[3838 + this.v_int]] = this.b_byteArr[this.a_shortArr[30]
                     + this.a_byteArr[2828 + this.v_int]];
               }
            ...
            this.a_bool7(this.a_byteArr[2828 + this.v_int], true, this.v_int);
         }

         if (this.f_bool) {
            if (this.a_byteArr[2828 + this.v_int] == 13 && (this.a_byteArr[2929 + this.v_int] & 255) < 145) {
               this.a_byteArr[2929 + this.v_int] = -110;
               this.a_byteArr[3636 + this.v_int]--;
               this.a_byteArr[404 + this.v_int] = 99;
               return false;
            }
   ...
   private boolean j_bool() {
      if (this.a_byteArr[2929 + this.v_int] == -116
         && this.a_byteArr[404 + this.v_int] >= this.b_byteArr[this.a_shortArr[49] + this.a_byteArr[2828 + this.v_int]]) {
         if (this.a_byteArr[2828 + this.v_int] >= 94 && this.a_byteArr[2828 + this.v_int] <= 97) {
            this.K();
         } else if (this.a_byteArr[2828 + this.v_int] == 55) {
            this.j_void(1);
            this.a_byteArr[404 + this.v_int] = 0;
         }
      } else if (this.b_byteArr[this.a_shortArr[33] + this.a_byteArr[2828 + this.v_int]] == 4
         && this.a_byteArr[404 + this.v_int] >= this.b_byteArr[this.a_shortArr[49] + this.a_byteArr[2828 + this.v_int]]) {
         if (this.a_byteArr[4646 + this.v_int] < 0) {
            if ((this.b_byteArr[this.a_shortArr[48] + this.a_byteArr[2828 + this.v_int]] & 2) == 0) {
               this.a_bool6(
                  this.b_byteArr[this.a_shortArr[45] + this.a_byteArr[2828 + this.v_int]],
                  this.b_byteArr[this.a_shortArr[46] + this.a_byteArr[2828 + this.v_int]],
                  this.b_byteArr[this.a_shortArr[47] + this.a_byteArr[2828 + this.v_int]],
            ...
            if ((this.b_byteArr[this.a_shortArr[70] + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]] & 2) == 0
               ...
               || this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] != 0) {
               this.f_bool = this.b_bool4(
                  this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] == 0 ? this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]] : 16,
                  this.a_byteArr[9115 + this.a_byteArr[4444 + this.v_int]] - 1
               );
            }
            ...
            if (this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] != 0) {
               ...
               while (this.S_int < 20 && this.g_byteArr2[0][this.S_int] != this.a_byteArr[4444 + this.v_int]) {
                  this.S_int++;
               }

               this.g_byteArr2[1][this.S_int]++;
            }
         }

         if (this.b_byteArr[this.a_shortArr[31] + this.a_byteArr[2828 + this.v_int]] != 13) {
            this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[31] + this.a_byteArr[2828 + this.v_int]]] + this.a_byteArr[3838 + this.v_int]] = (byte)(
               this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[31] + this.a_byteArr[2828 + this.v_int]]] + this.a_byteArr[3838 + this.v_int]]
                  + this.A_int
            );
         }

         this.a_byteArr[404 + this.v_int] = 0;
         if (this.a_byteArr[2828 + this.v_int] == 111) {
            this.f_bool = true;
         }

         if (this.a_byteArr[2828 + this.v_int] == 107) {
            if (this.z_int < 20) {
               this.f_bool = true;
            } else {
               this.a_byteArr[4444 + this.a_byteArr[4444 + this.v_int]] = (byte)this.v_int;
            }
         }

         if (this.b_byteArr[this.a_shortArr[31] + this.a_byteArr[2828 + this.v_int]] == 36
            && this.b_byteArr[this.a_shortArr[30] + this.a_byteArr[2828 + this.v_int]] == 99
            && this.a_byteArr[3636 + this.v_int] >= this.a_byteArr[3737 + this.v_int]) {
            this.f_bool = true;
         }

         if ((this.a_byteArr[2828 + this.v_int] == 11 || this.a_byteArr[2828 + this.v_int] == 14)
            && this.a_byteArr[3636 + this.v_int] < this.a_byteArr[3737 + this.v_int]) {
            this.N();
            return true;
         }

         if (this.a_byteArr[2828 + this.v_int] == 10
            || this.a_byteArr[2828 + this.v_int] == 15
            || this.a_byteArr[2828 + this.v_int] == 12
            || this.a_byteArr[2828 + this.v_int] == 16
            || this.a_byteArr[2828 + this.v_int] == 13) {
            this.a_byteArr[9883 + this.a_byteArr[4444 + this.v_int]]--;
            if (this.a_byteArr[9883 + this.a_byteArr[4444 + this.v_int]] < 0) {
               this.a_byteArr[9883 + this.a_byteArr[4444 + this.v_int]] = 0;
            }
         } else if (this.a_byteArr[2828 + this.v_int] == 54) {
            this.a_shortArr2[this.u_int][0]++;
         }
      }
   ...
   private boolean k_bool() {
      ...
      if (this.a_byteArr[2828 + this.v_int] == 26 || this.a_byteArr[2828 + this.v_int] == 27) {
         this.f_void3(true);
      }
      ...
      if (this.a_byteArr[2828 + this.v_int] == 109) {
         this.d_void3(this.v_int, 0);
      }

      if (this.a_byteArr[2828 + this.v_int] == 110) {
         this.a_byteArr[3535 + this.v_int] = 15;
      }

      if (this.a_byteArr[2828 + this.v_int] == 107) {
         this.c_void4(this.a_byteArr[4444 + this.v_int]);
      }
      ...
      if (this.a_byteArr[2828 + this.v_int] <= 4
         && this.b_byteArr2[this.a_byteArr[3232 + this.v_int]][this.a_byteArr[3131 + this.v_int]] == this.a_byteArr[4747 + this.v_int]
         && this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[31] + this.a_byteArr[2828 + this.v_int]]] + this.a_byteArr[4444 + this.v_int]] == 0) {
         this.a_void14(
            this.b_byteArr[this.a_shortArr[31] + this.a_byteArr[2828 + this.v_int]],
            this.a_byteArr[3131 + this.v_int],
            this.a_byteArr[3232 + this.v_int],
            this.a_byteArr[4444 + this.v_int]
         );
      ...
      if ((this.b_byteArr[this.a_shortArr[27] + this.a_byteArr[2828 + this.v_int]] & 8) != 0 && this.n_bool()) {
         return true;
      } else {
         if (this.a_byteArr[2828 + this.v_int] == 60) {
            this.a_void7(this.v_int, (byte)12);
            if (this.b_bool7(true)) {
               return true;
            }
         ...
         if (this.a_byteArr[1414 + this.v_int] < 11 && this.a_byteArr[2828 + this.v_int] == 17 && this.a_bool8(10)) {
            this.a_void7(this.v_int, (byte)73);
            this.g_void(1);
            return true;
         } else {
            return false;
   ...
   private void I() {
      if (this.a_byteArr[2828 + this.v_int] >= 83 && this.a_byteArr[3939 + this.v_int] >= 44 && this.a_byteArr[3939 + this.v_int] <= 48) {
         this.a_byteArr[3535 + this.v_int] = (byte)(this.a_byteArr[3939 + this.v_int] - 44 + 8);
      }

      if (this.a_byteArr[2828 + this.v_int] == 85) {
         if (this.a_byteArr[6161 + this.v_int] >= 2) {
            this.a_byteArr[3939 + this.v_int] = 69;
         }

         this.a_void7(this.v_int, this.a_byteArr[3939 + this.v_int]);
         if (this.a_byteArr[2828 + this.v_int] >= 44 && this.a_byteArr[2828 + this.v_int] <= 48) {
            this.a_byteArr[3535 + this.v_int] = 0;
         }
         ...
         this.a_void7(
            this.v_int,
            this.a_byteArr[2828 + this.v_int] >= 19 && this.a_byteArr[2828 + this.v_int] <= 26 && this.a_byteArr[6464 + this.v_int] == 69
               ? 69
               : this.b_byteArr[this.a_shortArr[160] + this.a_byteArr[2828 + this.v_int]]
         );
      }
      ...
      if (this.a_byteArr[6161 + this.v_int] < 2
         && (
            this.b_byteArr[this.a_shortArr[39] + this.a_byteArr[2828 + this.v_int]] == 2
               || this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] == this.v_int
         )) {
         this.N();
      }

      if (this.a_byteArr[2828 + this.v_int] == 16) {
         this.an();
      }
   }
   ...
   private void J() {
      this.A_int = 1;
      if ((this.b_byteArr[this.a_shortArr[27] + this.a_byteArr[2828 + this.v_int]] & 32) == 0) {
         this.A_int = -1;
      }

      this.C_int = (
            this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[35] + this.a_byteArr[2828 + this.v_int]]] + this.v_int]
               + this.b_byteArr[this.a_shortArr[36] + this.a_byteArr[2828 + this.v_int]]
         )
         * this.A_int;
      if (this.b_byteArr[this.a_shortArr[35] + this.a_byteArr[2828 + this.v_int]] >= 69
         && this.b_byteArr[this.a_shortArr[35] + this.a_byteArr[2828 + this.v_int]] <= 74
         && this.u_int == 0
         ...
         && this.a_byteArr[101 + this.v_int] - this.a_byteArr[101 + this.a_shortArr2[0][17]] <= 4) {
         this.C_int = this.C_int * 3 / 2;
      }

      if (this.b_byteArr[this.a_shortArr[33] + this.a_byteArr[2828 + this.v_int]] <= 0) {
         this.a_shortArr2[this.u_int][-this.b_byteArr[this.a_shortArr[33] + this.a_byteArr[2828 + this.v_int]]] = (short)(
            this.a_shortArr2[this.u_int][-this.b_byteArr[this.a_shortArr[33] + this.a_byteArr[2828 + this.v_int]]] + this.C_int
         );
      } else {
         this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[33] + this.a_byteArr[2828 + this.v_int]]] + this.v_int] = (byte)(
            this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[33] + this.a_byteArr[2828 + this.v_int]]] + this.v_int] + this.C_int
         );
      }

      this.A_int = 1;
      if ((this.b_byteArr[this.a_shortArr[27] + this.a_byteArr[2828 + this.v_int]] & 16) == 0) {
         this.A_int = -1;
      }

      this.C_int = this.b_byteArr[this.a_shortArr[34] + this.a_byteArr[2828 + this.v_int]] >= 0
         ? this.b_byteArr[this.a_shortArr[34] + this.a_byteArr[2828 + this.v_int]]
         : this.a_byteArr[this.b_shortArr[-this.b_byteArr[this.a_shortArr[34] + this.a_byteArr[2828 + this.v_int]]] + this.v_int];
      this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[31] + this.a_byteArr[2828 + this.v_int]]] + this.a_byteArr[3838 + this.v_int]] = (byte)(
         this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[31] + this.a_byteArr[2828 + this.v_int]]] + this.a_byteArr[3838 + this.v_int]]
            + this.C_int * this.A_int
      );
      this.R_int = this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[31] + this.a_byteArr[2828 + this.v_int]]]
         + this.a_byteArr[3838 + this.v_int]];
   }
   ...
   private void K() {
      ...
      this.f_bool = true;
      switch (this.a_byteArr[2828 + this.v_int]) {
         case 94:
            this.f_bool = this.a_bool5(this.a_byteArr[4444 + this.v_int], 10);
            return;
         case 95:
            this.a_byteArr[8181 + this.a_byteArr[4444 + this.v_int]] = 0;
            this.a_byteArr[7979 + this.a_byteArr[4444 + this.v_int]] = (byte)(this.a_byteArr[7979 + this.a_byteArr[4444 + this.v_int]] | 8);
            return;
         case 96:
            this.a_byteArr[505 + this.R_int] = 99;
            this.R_int = this.v_int;
            this.v_int = this.a_byteArr[4444 + this.v_int];
            if ((this.a_byteArr[8282 + this.v_int] & 127) >> 1 == 0) {
               this.a_bool10(true);
            }

            this.v_int = this.R_int;
            return;
         case 97:
      ...
      for (this.S_int = this.a_byteArr[8993 + this.a_byteArr[4444 + this.v_int]];
         ...
         if (this.S_int != this.v_int) {
            if (var1 == 0) {
               ...
               this.a_byteArr[2121 + this.S_int] = (byte)b_int2(
                  this.a_byteArr[2121 + this.S_int] + (this.a_byteArr[7272 + this.v_int] + 2) / 2, 0, 99
               );
            } else {
               this.a_bool5(this.S_int, 10);
               if (this.a_byteArr[1919 + this.S_int] >= this.a_byteArr[6767 + this.S_int]) {
                  this.a_byteArr[2828 + this.S_int] = 87;
                  this.a_byteArr[6161 + this.S_int] = 3;
               }
            }
         }
      }
   ...
   private boolean l_bool() {
      for (this.A_int = this.b_byteArr[this.a_shortArr[166] + this.a_byteArr[2828 + this.v_int]] & 255;
         this.A_int < (this.b_byteArr[this.a_shortArr[166] + this.a_byteArr[2828 + this.v_int] + 1] & 255);
         this.A_int++
      ) {
         if (this.a_byteArr[2929 + this.v_int] == this.b_byteArr[this.a_shortArr[164] + this.A_int]) {
            return true;
         }
      }
   ...
   private boolean a_bool6(byte var1, byte var2, byte var3, byte var4) {
      ...
      if (this.a_obj_f.a_int2(16777215, 100) < var2 && this.U * var4 < var3 * var4) {
         ...
         if (var1 == 4) {
            ...
            this.a_byteArr[1919 + this.v_int] = (byte)(this.a_byteArr[1919 + this.v_int] + (this.a_byteArr[6767 + this.v_int] - this.U));
            return true;
         }
      }
         ...
         if (var1 != 99) {
            ...
            if (this.a_byteArr[8627 + this.W] == 2) {
               for (this.R_int = 0; this.R_int < 3; this.R_int++) {
                  this.a_shortArr2[this.u_int][2 + this.R_int] = (short)(
                     this.a_shortArr2[this.u_int][2 + this.R_int]
            ...
            for (this.aK = 0; this.aK < 20; this.aK++) {
               if (this.g_byteArr2[0][this.aK] == this.W) {
                  this.g_byteArr2[2][this.aK] = (byte)(
                     this.a_byteArr[8627 + this.W] == 2
                        ? -this.V
   ...
   private void L() {
      this.X = this.a_byteArr[1717 + this.v_int] < this.a_byteArr[1616 + this.v_int] ? 3 : 0;

      for (this.Y = this.X; this.Y < 6 + this.X; this.Y++) {
         if (this.a_shortArr2[this.u_int][this.b_byteArr[this.a_shortArr[88] + this.b_byteArr[this.a_shortArr[103] + this.Y]]]
            >= this.b_byteArr[this.a_shortArr[104] + this.Y]) {
            this.a_shortArr2[this.u_int][this.b_byteArr[this.a_shortArr[88] + this.b_byteArr[this.a_shortArr[103] + this.Y]]] = (short)(
               this.a_shortArr2[this.u_int][this.b_byteArr[this.a_shortArr[88] + this.b_byteArr[this.a_shortArr[103] + this.Y]]]
                  - this.b_byteArr[this.a_shortArr[104] + this.Y]
            );
   ...
   private void M() {
      this.a_byteArr[3939 + this.v_int] = this.a_byteArr[2828 + this.v_int];
      this.a_void7(this.v_int, (byte)83);
   ...
   private void N() {
      if (this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] != this.v_int) {
         if (this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]] == 2 && this.a_byteArr[4646 + this.v_int] == 0) {
            this.Z = this.a_byteArr[8993 + this.a_byteArr[4444 + this.v_int]];
            if (this.Z == this.v_int) {
               this.Z = this.a_byteArr[4545 + this.v_int];
            }

            if (this.Z > 0) {
               this.a_byteArr[4646 + this.v_int] = this.a_byteArr[4646 + this.Z];
               this.a_byteArr[4646 + this.Z] = 0;
            }
         }

         this.g_void(2);
      } else if (this.a_byteArr[2828 + this.v_int] == 17
         || this.a_byteArr[2828 + this.v_int] == 60
         || this.a_byteArr[2828 + this.v_int] == 83
         || (this.a_byteArr[2828 + this.v_int] == 11 || this.a_byteArr[2828 + this.v_int] == 14) && this.a_byteArr[3636 + this.v_int] > 0) {
         this.a_byteArr[1313 + this.v_int] = 0;
         if (this.a_byteArr[2828 + this.v_int] == 17
            && this.a_byteArr[4444 + this.v_int] > (this.u_int ^ 1) * 50
            && this.a_byteArr[4444 + this.v_int] <= ((this.u_int ^ 1) + 1) * 50) {
            if (this.a_byteArr[2828 + this.a_byteArr[4444 + this.v_int]] == 107) {
               this.a_byteArr[3131 + this.v_int] = this.a_byteArr[0 + this.a_byteArr[4444 + this.v_int]];
               this.a_byteArr[3232 + this.v_int] = this.a_byteArr[101 + this.a_byteArr[4444 + this.v_int]];
            } else {
               this.a_byteArr[4444 + this.v_int] = 0;
            }
         } else {
            if (this.a_byteArr[2828 + this.v_int] == 17 || this.a_byteArr[2828 + this.v_int] == 60 || this.a_byteArr[2828 + this.v_int] == 83) {
               this.a_byteArr[4747 + this.v_int] = 0;
            }
         ...
         this.ae = ((this.a_byteArr[8282 + this.v_int] & 127) >> 1) - 1;
         this.a_bool4(3, 127, this.c_byteArr2[2][this.ae], this.c_byteArr2[3][this.ae]);
         this.g_void(3);
      } else if (this.a_byteArr[2828 + this.v_int] == 110) {
         if (!this.a_bool4(4, this.a_byteArr[4949 + this.v_int] * 2 + 1, this.a_byteArr[0 + this.v_int], this.a_byteArr[101 + this.v_int])) {
            this.a_void7(this.v_int, (byte)109);
            this.ae = ((this.a_byteArr[8282 + this.v_int] & 127) >> 1) - 1;
            this.a_bool4(3, 127, this.c_byteArr2[2][this.ae], this.c_byteArr2[3][this.ae]);
         }
   ...
   private void O() {
      if (this.a_byteArr[2828 + this.v_int] == 69
         || this.a_byteArr[2828 + this.v_int] == 80
         || this.a_byteArr[2828 + this.v_int] == 84
         || this.a_byteArr[2828 + this.v_int] == 85) {
         this.a_byteArr[3131 + this.v_int] = this.a_byteArr[0 + this.v_int];
         this.a_byteArr[3232 + this.v_int] = this.a_byteArr[101 + this.v_int];
         ...
         if (this.a_byteArr[2828 + this.v_int] == 27) {
            ...
            if ((this.b_byteArr[this.a_shortArr[27] + this.a_byteArr[2828 + this.v_int]] & 64) > 0) {
               if (this.a_byteArr[2828 + this.v_int] != 65) {
                  this.a_byteArr[3131 + this.v_int] = this.a_byteArr[6262 + this.v_int];
                  this.a_byteArr[3232 + this.v_int] = this.a_byteArr[6363 + this.v_int];
               } else {
                  this.a_byteArr[3131 + this.v_int] = this.a_byteArr[8383 + this.a_byteArr[3434 + this.v_int]];
                  this.a_byteArr[3232 + this.v_int] = this.a_byteArr[8444 + this.a_byteArr[3434 + this.v_int]];
               }
            ...
            this.a_byteArr[4444 + this.v_int] = -6;
         }
      }
   }
   ...
   final boolean a_bool8(int var1) {
            ...
            if ((this.a_byteArr[8627 + this.Z] == 0 || var1 == 6)
               ...
               this.ab = (
                        this.a_byteArr[8383 + this.Z]
                           + this.b_byteArr[this.a_shortArr[138] + 104 + this.a_byteArr[8749 + this.Z]] / 2
                           - this.a_byteArr[0 + this.v_int]
                     )
                     * (
                        this.a_byteArr[8383 + this.Z]
      ...
      if (this.aa < 1000000) {
         this.a_byteArr[3131 + this.v_int] = (byte)b_int2(
            this.a_byteArr[0 + this.v_int],
            this.a_byteArr[8383 + this.ac],
            this.a_byteArr[8383 + this.ac] + this.b_byteArr[this.a_shortArr[138] + 104 + this.a_byteArr[8749 + this.ac]] - 1
         );
         this.a_byteArr[3232 + this.v_int] = (byte)b_int2(
            this.a_byteArr[101 + this.v_int],
            this.a_byteArr[8444 + this.ac],
            this.a_byteArr[8444 + this.ac] + this.b_byteArr[this.a_shortArr[138] + 130 + this.a_byteArr[8749 + this.ac]] - 1
         );
         return true;
      } else {
         this.a_byteArr[3131 + this.v_int] = this.a_byteArr[0 + this.v_int];
   ...
   private boolean m_bool() {
      if (this.u_int == 1) {
         if ((this.a_byteArr[7979 + this.v_int] & 32) != 0 && this.Q_byte >= 1) {
            if (this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] == this.v_int) {
               this.a_byteArr[3131 + this.v_int] = this.a_byteArr[0 + this.Q_byte];
               this.a_byteArr[3232 + this.v_int] = this.a_byteArr[101 + this.Q_byte];
               this.a_byteArr[7979 + this.v_int] = (byte)(this.a_byteArr[7979 + this.v_int] & 223);
               this.a_void7(this.v_int, (byte)69);
            } else {
               this.a_byteArr[2828 + this.v_int] = 87;
            ...
            if (this.a_obj_f.N_bool && (this.a_byteArr[7979 + this.v_int] & 64) != 0) {
               ...
               if (this.a_byteArr[2828 + this.v_int] != 50) {
                  if (this.a_bool8(6) && this.a_byteArr[6565 + this.v_int] == 9) {
                     this.a_void7(this.v_int, (byte)50);
                     this.a_byteArr[6161 + this.v_int] = 3;
                     this.a_byteArr[7777 + this.v_int] = 3;
                     return true;
                  }
   ...
   private boolean n_bool() {
      if (this.a_obj_f.q_byte != 3
         ...
         if (this.u_int == 0) {
            ...
            if (this.a_bool10(false)) {
               return true;
            }
         }

         if (this.b_byteArr[this.a_shortArr[50] + this.a_byteArr[2828 + this.v_int]] == 127
            || this.b_byteArr[this.a_shortArr[52] + this.a_byteArr[2828 + this.v_int]] == 127) {
            return false;
         } else if (this.a_byteArr[2121 + this.v_int] <= (this.a_byteArr[505 + this.v_int] > 5 ? 20 : 50)) {
            if (this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] != this.v_int) {
               this.a_void7(this.v_int, (byte)87);
               this.g_void(1);
            } else {
               ...
               if (this.a_byteArr[3434 + this.v_int] > 0
                  ...
                  this.a_byteArr[3232 + this.v_int] = this.a_byteArr[8444 + this.a_byteArr[3434 + this.v_int]];
                  this.g_void(1);
               } else if (this.aJ == 1 && this.a_bool8(7)) {
                  this.g_void(1);
               } else {
                  this.a_byteArr[3131 + this.v_int] = this.a_byteArr[0 + this.v_int];
                  this.a_byteArr[3232 + this.v_int] = this.a_byteArr[101 + this.v_int];
                  this.a_void7(this.v_int, (byte)79);
                  this.a_byteArr[2929 + this.v_int] = 40;
                  this.a_byteArr[3030 + this.v_int] = 0;
               }

               if (this.a_byteArr[3434 + this.v_int] <= 0) {
                  this.a_void19((byte)1, this.v_int, this.v_int);
               }
            }

            return true;
         } else if (this.a_byteArr[2020 + this.v_int] <= (this.a_byteArr[505 + this.v_int] > 5 ? 20 : 50)
            && this.a_byteArr[6464 + this.v_int] != 66
            && this.a_byteArr[2828 + this.v_int] != 66
            && this.a_bool9(4, (byte)0)) {
            return true;
         } else {
            if (this.a_byteArr[505 + this.v_int] <= 30 && this.a_byteArr[6464 + this.v_int] != 86 && this.a_byteArr[2828 + this.v_int] != 86) {
               if (this.a_bool9(7, (byte)2)) {
                  return true;
               }

               if (this.a_byteArr[505 + this.v_int] <= 5 && this.b_byteArr[this.a_shortArr[41] + this.a_byteArr[2828 + this.v_int]] != 0) {
                  if (this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] != this.v_int) {
                     this.a_void7(this.v_int, (byte)87);
                     this.a_byteArr[6161 + this.v_int] = 3;
                     return true;
            ...
            return (this.a_byteArr[1919 + this.v_int] < this.a_byteArr[6767 + this.v_int] * 2 / 3 || (this.a_byteArr[7979 + this.v_int] & 4) != 0)
               && this.a_byteArr[6464 + this.v_int] != 57
               && this.a_byteArr[2828 + this.v_int] != 57
               && this.a_bool9(8, (byte)3);
         }
      } else {
         return false;
      }
               ...
               while (true) {
                  if (this.a_byteArr[8505 + this.ae] >= 0
                     ...
                     if (++var2 > var3) {
                        ...
                        this.c_byteArr2[1][this.x_int] = (byte)this.ad;
                        this.a_byteArr[8282 + this.v_int] = (byte)(this.a_byteArr[8282 + this.v_int] + (this.x_int + 1 << 1));
                        this.a_byteArr[8282 + this.ad] = (byte)(this.a_byteArr[8282 + this.ad] + (this.x_int + 1 << 1) + 1);
                        this.c_byteArr2[5][this.x_int] = (byte)this.ae;
                        this.a_byteArr[9237 + this.ae] = 1;
                        this.c_byteArr2[2][this.x_int] = (byte)(this.a_byteArr[8383 + this.ae] + 1);
                        this.c_byteArr2[3][this.x_int] = (byte)(this.a_byteArr[8444 + this.ae] + 2);
                        this.a_void7(this.v_int, (byte)(110 - this.a_byteArr[1515 + this.v_int]));
                        this.N();
                        return true;
                     }
                  }
   ...
   private boolean o_bool() {
      this.x_int = ((this.a_byteArr[8282 + this.v_int] & 127) >> 1) - 1;
      if (this.x_int < 0) {
         return false;
      } else {
         if (this.a_byteArr[2828 + this.v_int] < 109) {
            this.a_void7(this.v_int, (byte)(110 - this.a_byteArr[1515 + this.v_int]));
            this.c_byteArr2[4][this.x_int] = 2;
            if (this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] == this.v_int) {
               this.N();
            } else {
               this.g_void(3);
            }
         } else if (this.c_byteArr2[4][this.x_int] == 2) {
            if (this.a_byteArr[0 + this.c_byteArr2[0][this.x_int]] != this.a_byteArr[3131 + this.c_byteArr2[0][this.x_int]]
               || this.a_byteArr[101 + this.c_byteArr2[0][this.x_int]] != this.a_byteArr[3232 + this.c_byteArr2[0][this.x_int]]
               || this.a_byteArr[0 + this.c_byteArr2[1][this.x_int]] != this.a_byteArr[3131 + this.c_byteArr2[0][this.x_int]] + 1
               || this.a_byteArr[101 + this.c_byteArr2[1][this.x_int]] != this.a_byteArr[3232 + this.c_byteArr2[0][this.x_int]]
               || this.a_byteArr[2828 + this.c_byteArr2[0][this.x_int]] != 109
               || this.a_byteArr[2828 + this.c_byteArr2[1][this.x_int]] != 109
               || this.a_byteArr[202 + this.c_byteArr2[0][this.x_int]] != 0
               || this.a_byteArr[303 + this.c_byteArr2[0][this.x_int]] != 0
               || this.a_byteArr[202 + this.c_byteArr2[1][this.x_int]] != 0
               || this.a_byteArr[303 + this.c_byteArr2[1][this.x_int]] != 0) {
               return true;
            }

            this.C_int = this.c_byteArr2[0 + this.a_byteArr[1515 + this.c_byteArr2[0][this.x_int]]][this.x_int];
            this.D_int = this.c_byteArr2[1 - this.a_byteArr[1515 + this.c_byteArr2[0][this.x_int]]][this.x_int];
            if (this.a_byteArr[2929 + this.C_int] != -99) {
               this.a_byteArr[2929 + this.C_int] = -99;
               this.a_byteArr[2929 + this.D_int] = -98;
               this.a_byteArr[2828 + this.C_int] = 109;
               this.a_byteArr[3030 + this.C_int] = 0;
               this.a_byteArr[3030 + this.D_int] = 0;
               this.a_byteArr[606 + this.c_byteArr2[0][this.x_int]] = 0;
               ...
               this.a_byteArr[3232 + this.D_int] = this.a_byteArr[8444 + this.c_byteArr2[5][this.x_int]];
               this.a_byteArr[2828 + this.C_int] = 111;
               this.a_byteArr[2828 + this.D_int] = 111;
               this.a_byteArr[808 + this.C_int] = 0;
               this.a_byteArr[808 + this.D_int] = 0;
               this.c_byteArr2[4][this.x_int] = 3;
               this.ae = this.v_int;
               this.v_int = this.c_byteArr2[0][this.x_int];
               this.g_void(3);
               this.v_int = this.c_byteArr2[1][this.x_int];
               this.g_void(3);
               this.v_int = this.ae;
            }
         } else if (this.a_byteArr[2828 + this.v_int] == 111) {
            this.a_byteArr[9237 + this.c_byteArr2[5][this.x_int]] = 3;
            this.d_void3(this.v_int, 0);
         }
   ...
   private void d_void3(int var1, int var2) {
      ...
      if (this.ae >= 0) {
         ...
         this.a_byteArr[8282 + this.c_byteArr2[1][this.ae]] = (byte)(this.a_byteArr[8282 + this.c_byteArr2[1][this.ae]] & 128);
         if (this.a_byteArr[9237 + this.c_byteArr2[5][this.ae]] < 3) {
            this.a_byteArr[9237 + this.c_byteArr2[5][this.ae]] = 0;
         }
      }
   }
   ...
   // $VF: renamed from: P () void
   private void P() {
      this.a_byteArr[2929 + this.v_int] = (byte)(this.b_byte3(this.v_int) % 7 + 8);
   }
   ...
   private void Q() {
      if (this.a_byteArr[1414 + this.v_int] >= 12) {
         ...
         this.a_void7(this.v_int, (byte)17);
      }
   }
   ...
   private boolean p_bool() {
      if ((this.a_obj_f.q_byte != 3 || this.f_byte < 5) && (this.a_obj_f.q_byte != 2 || this.f_byte != 1)) {
         ...
         if (this.y_byte <= 0) {
            ...
            if (!this.b_bool && this.a_byteArr[2828 + this.v_int] <= 9) {
               this.a_bool = this.a_bool
                  && (
                     this.b_byteArr[this.a_shortArr[122] + this.a_byteArr[2828 + this.v_int]] < this.y_byte
                        || this.z_int / 10 > this.B_int && this.an <= this.B_int
                  );
            }
      ...
      for (this.ah = this.at; this.ah <= this.au; this.ah++) {
         for (this.ai = this.av; this.ai <= this.aw; this.ai++) {
            for (this.ak = this.c_byteArr3[this.aj][this.ai][this.ah];
               this.ak >= 0;
               this.ak = this.a_byteArr2[this.aj][this.ak]
            ) {
               this.al = this.ak + this.b_byteArr[this.a_shortArr[115] + this.aj];
               this.ap = this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[118] + this.aj]] + this.al]
               ...
               if (var3 == 0) {
                  if (this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[117] + this.aj]] + this.al] > 0
                     ...
                     if (this.y_byte < this.am || this.y_byte == this.am && this.ao < this.an) {
                        ...
                        this.an = this.ao;
                        this.z_byte = (byte)this.ap;
                        this.A_byte = (byte)this.aq;
                  ...
                  && this.a_byteArr[2828 + this.al] > 9
                  && this.a_byteArr[2828 + this.al] != 59
      ...
      try {
         if (this.a_byteArr[5959 + this.v_int] <= 0) {
            ...
            if (this.b_byteArr[this.a_shortArr[53]
                  ...
                  / 10
               <= this.B_int) {
               this.ax = this.b_shortArr[this.c_shortArr[1]
                  + (this.aF > 0 ? this.aF : -this.aF) * 11
                  + (this.aE > 0 ? this.aE : -this.aE)];
               this.a_byteArr[5959 + this.v_int] = (byte)(
                  this.ax > this.b_byteArr[this.a_shortArr[159] + this.aG] ? this.ax / this.b_byteArr[this.a_shortArr[159] + this.aG] : 1
               );
               this.ay = this.az = this.aA = this.aB = 0;
               this.a_byteArr[7878 + this.v_int] = 9;
               if ((this.b_byteArr[this.a_shortArr[27] + this.a_byteArr[2828 + this.v_int]] & 2) > 0) {
                  if (this.a_byteArr[4747 + this.v_int] > 100) {
                     if ((this.a_byteArr[9557 + this.a_byteArr[4444 + this.v_int]] & 255) <= 7) {
                        this.aB = this.b_byteArr[this.a_shortArr[179] + this.a_byteArr[9535 + this.a_byteArr[4444 + this.v_int]]];
                        this.aC = this.a_byteArr[9491 + this.a_byteArr[4444 + this.v_int]];
                        this.aD = 101;
                     }
                  } else if ((this.a_byteArr[2929 + this.a_byteArr[4444 + this.v_int]] & 255) <= 7) {
                     this.aB = this.a_byteArr[1010 + this.a_byteArr[4444 + this.v_int]] - this.a_byteArr[7777 + this.a_byteArr[4444 + this.v_int]];
                     this.aC = this.a_byteArr[606 + this.a_byteArr[4444 + this.v_int]];
                     this.aD = 2;
                  }

                  if (this.aB > 0) {
                     this.a_byteArr[7878 + this.v_int] = (byte)this.aB;
                     this.az = this.a_byteArr[this.b_shortArr[this.aD] + this.a_byteArr[4444 + this.v_int]]
                        + this.b_byteArr[this.a_shortArr[1] + 0 + this.aC]
                           * 22
                           * this.a_byteArr[5959 + this.v_int]
                           / this.b_byteArr[this.a_shortArr[15] + (this.aC & 1) * 9 + this.aB];
                     this.aA = this.a_byteArr[this.b_shortArr[this.aD + 1] + this.a_byteArr[4444 + this.v_int]]
                        + this.b_byteArr[this.a_shortArr[1] + 8 + this.aC]
                           * 16
                           * this.a_byteArr[5959 + this.v_int]
                           / this.b_byteArr[this.a_shortArr[15] + (this.aC & 1) * 9 + this.aB];
                  }
               ...
               this.a_byteArr[5656 + this.v_int] = (byte)(
                  (this.aE * 22 + this.az + (this.aE > 0 ? 1 : -1) * this.a_byteArr[5959 + this.v_int] / 2)
                     / this.a_byteArr[5959 + this.v_int]
               );
               this.a_byteArr[5757 + this.v_int] = (byte)(
                  (this.aF * 16 + this.aA + (this.aF > 0 ? 1 : -1) * this.a_byteArr[5959 + this.v_int] / 2)
                     / this.a_byteArr[5959 + this.v_int]
               );
   ...
   // $VF: renamed from: R () void
   private void R() {
      if (this.a_byteArr[5858 + this.v_int] < this.a_byteArr[5959 + this.v_int]) {
         this.a_byteArr[5454 + this.v_int] = (byte)(this.a_byteArr[5454 + this.v_int] + this.a_byteArr[5656 + this.v_int]);
         this.a_byteArr[5555 + this.v_int] = (byte)(this.a_byteArr[5555 + this.v_int] + this.a_byteArr[5757 + this.v_int]);
         this.a_byteArr[5252 + this.v_int] = (byte)(this.a_byteArr[5252 + this.v_int] + ((this.a_byteArr[5454 + this.v_int] + 11 + 66) / 22 - 3));
         this.a_byteArr[5353 + this.v_int] = (byte)(this.a_byteArr[5353 + this.v_int] + ((this.a_byteArr[5555 + this.v_int] + 8 + 48) / 16 - 3));
         this.a_byteArr[5454 + this.v_int] = (byte)(this.a_byteArr[5454 + this.v_int] - ((this.a_byteArr[5454 + this.v_int] + 11 + 66) / 22 - 3) * 22);
         this.a_byteArr[5555 + this.v_int] = (byte)(this.a_byteArr[5555 + this.v_int] - ((this.a_byteArr[5555 + this.v_int] + 8 + 48) / 16 - 3) * 16);
      }

      this.a_byteArr[5858 + this.v_int]++;
      if (this.a_byteArr[5858 + this.v_int] > this.a_byteArr[5959 + this.v_int]) {
         this.S();
      }
   }
   ...
   private void S() {
      this.a_byteArr[5959 + this.v_int] = 0;
      this.a_bool11(
         this.a_byteArr[5252 + this.v_int],
         this.a_byteArr[5353 + this.v_int],
         this.u_int,
         this.a_byteArr[2828 + this.v_int] <= 9
            ...
            : (
               this.a_byteArr[2828 + this.v_int] == 92
                  ? 1
                  : (this.a_byteArr[2828 + this.v_int] == 93 ? 2 : (this.a_byteArr[2828 + this.v_int] == 106 ? 5 : 0))
            ),
         this.a_byteArr[4444 + this.v_int],
         0,
   ...
   private void c_void5(int var1, int var2, int var3) {
      if (this.a_bool11(
         ...
         && (this.a_byteArr[2929 + this.v_int] & 255) >= 31
         && this.a_byteArr[6565 + this.v_int] != 9
         && this.k_byteArr[0] == 1
         && this.a_byteArr[202 + this.k_byteArr[2]] == 0
         && this.a_byteArr[303 + this.k_byteArr[2]] == 0
         && (this.a_byteArr[2929 + this.k_byteArr[2]] < 106 || this.a_byteArr[2929 + this.k_byteArr[2]] > 108)) {
         this.a_byteArr[2929 + this.k_byteArr[2]] = 42;
         this.a_byteArr[3030 + this.k_byteArr[2]] = 0;
         this.a_byteArr[4646 + this.k_byteArr[2]] = (byte)(-(62 + (this.x_int & 1)));
      }
   }
      ...
      if (this.a_obj_f.ag_bool && this.k_byteArr[0] == 1 && this.k_byteArr[2] <= 50) {
         ...
         if (this.k_byteArr[0] == 2) {
            if ((this.a_byteArr[9054 + this.k_byteArr[2]] & 128) == 0) {
               ...
               this.a_void11(
                  ...
                  (byte)(this.a_byteArr[8444 + this.k_byteArr[2]] + this.b_byteArr[this.a_shortArr[138] + 130 + this.k_byteArr[1]] / 2),
                  (byte)8
               );
               this.u_int ^= 1;
            }
         ...
         if ((var7 = var7 / (this.ay + 1)) < 1) {
            ...
            if (this.k_byteArr[0] == 1
               && this.a_byteArr[1919 + this.k_byteArr[2]] > 0
               && this.a_byteArr[1414 + this.k_byteArr[2]] >= 12
               && this.a_byteArr[6161 + this.k_byteArr[2]] == 0
               && this.a_byteArr[2828 + this.k_byteArr[2]] > 9
               && this.a_byteArr[2828 + this.k_byteArr[2]] != 59
               && this.a_byteArr[2828 + this.k_byteArr[2]] != 87
               && this.a_byteArr[2828 + this.k_byteArr[2]] != 50) {
               this.a_byteArr[6161 + this.k_byteArr[2]] = 4;
               this.a_byteArr[4747 + this.k_byteArr[2]] = (byte)this.v_int;
            }
   ...
   private void T() {
      for (this.u_int = 0; this.u_int < 2; this.u_int++) {
         for (this.v_int = this.u_int * 50 + 1; this.v_int <= (this.u_int + 1) * 50; this.v_int++) {
            if (this.a_byteArr[5959 + this.v_int] > 0
               && this.a_byteArr[5252 + this.v_int] >= this.a_obj_f.I_byte
               && this.a_byteArr[5252 + this.v_int] < this.a_obj_f.I_byte + this.a_obj_f.O_byte
               && this.a_byteArr[5353 + this.v_int] >= this.a_obj_f.K_byte
               && this.a_byteArr[5353 + this.v_int] < this.a_obj_f.K_byte + this.a_obj_f.P_byte) {
               this.a_byteArr[6060 + this.v_int] = this.a_obj_f.g_byteArr2[this.a_byteArr[5353 + this.v_int] - this.a_obj_f.K_byte][this.a_byteArr[5252
                     + this.v_int]
                  - this.a_obj_f.I_byte];
               this.a_obj_f.g_byteArr2[this.a_byteArr[5353 + this.v_int] - this.a_obj_f.K_byte][this.a_byteArr[5252 + this.v_int]
                  - this.a_obj_f.I_byte] = (byte)this.v_int;
            }
         }
      }
   }
   ...
   private void U() {
      this.b_void2(true);
      if (this.a_byteArr[4646 + this.v_int] == 1
         && this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]] == 8
         && this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] == 0) {
         this.a_byteArr[2828 + this.a_byteArr[8810 + this.a_byteArr[4444 + this.v_int]]] = 57;
         this.a_byteArr[2929 + this.a_byteArr[8810 + this.a_byteArr[4444 + this.v_int]]] = 105;
         this.a_byteArr[3030 + this.a_byteArr[8810 + this.a_byteArr[4444 + this.v_int]]] = 0;
      }

      this.a_byteArr[2929 + this.v_int] = this.a_byteArr[1414 + this.v_int] >= 12
            && this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]] < 12
            && (
               this.a_byteArr[8627 + this.a_byteArr[4444 + this.v_int]] != 0 || this.b_byteArr[this.a_shortArr[41] + this.a_byteArr[2828 + this.v_int]] == 12
            )
         ? this.b_byteArr[this.a_shortArr[176]
            + this.b_byteArr[this.a_shortArr[177] + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]]
            + this.a_byteArr[4646 + this.v_int]]
   ...
   // $VF: renamed from: V () void
   private void V() {
      if (this.v_int == this.a_shortArr2[this.u_int][17]) {
         this.a_byteArr[3434 + this.v_int] = 1;
      } else {
         for (this.aI = this.u_int * 30 + 1; this.aI <= (this.u_int + 1) * 30; this.aI++) {
            if (this.a_byteArr[8749 + this.aI] == 2
               && this.a_byteArr[8627 + this.aI] == 0
               && this.a_byteArr[8810 + this.aI] < this.b_byteArr[this.a_shortArr[138] + (this.a_byteArr[9115 + this.aI] - 1) * 26 + 2]) {
               this.a_byteArr[3434 + this.v_int] = (byte)this.aI;
               this.a_byteArr[8810 + this.aI]++;
               return;
            }
         }
      }
   ...
   private boolean q_bool() {
      if (this.a_byteArr[6666 + this.v_int] >= (this.u_int == 0 ? 125 : 50)) {
         ...
         this.a_byteArr[6767 + this.v_int] = (byte)b_int2(
            this.a_byteArr[6767 + this.v_int] + this.aJ, 0, this.b_byteArr[this.a_shortArr[98] + this.a_byteArr[1414 + this.v_int]]
         );
         if (this.aJ > 0) {
            this.a_byteArr[1919 + this.v_int] = (byte)(this.a_byteArr[1919 + this.v_int] + this.aJ);
            if (this.a_byteArr[6767 + this.v_int] >= 55
               && this.a_byteArr[6767 + this.v_int] - this.aJ < 55
               && this.a_byteArr[1010 + this.v_int] > 6
               && this.a_byteArr[202 + this.v_int] == 0
               && this.a_byteArr[303 + this.v_int] == 0) {
               this.a_byteArr[1010 + this.v_int]--;
            }
         }

         this.a_byteArr[1919 + this.v_int] = (byte)b_int2(this.a_byteArr[1919 + this.v_int], 0, this.a_byteArr[6767 + this.v_int]);
         if (!this.s_bool()) {
            return false;
         }
         ...
         if (this.a_byteArr[1414 + this.v_int] == 12) {
            ...
            this.A();
            this.a_byteArr[6464 + this.v_int] = 69;
            this.a_byteArr[3030 + this.v_int] = 20;
            this.a_byteArr[6262 + this.v_int] = this.a_byteArr[3131 + this.v_int] = this.a_byteArr[0 + this.v_int];
            this.a_byteArr[6363 + this.v_int] = this.a_byteArr[3232 + this.v_int] = this.a_byteArr[101 + this.v_int];
         }
      ...
      if (this.a_byteArr[1414 + this.v_int] == 11
         && this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] != this.v_int
         && this.a_byteArr[1313 + this.v_int] >= 0) {
         this.a_byteArr[6161 + this.v_int] = 3;
         this.a_void7(this.v_int, (byte)59);
      ...
      if (!this.r_bool()) {
         ...
         if ((this.a_byteArr[7979 + this.v_int] & 8) > 0) {
            this.a_byteArr[8181 + this.v_int]++;
            if (this.a_byteArr[8181 + this.v_int] >= 120) {
               this.a_byteArr[8181 + this.v_int] = 0;
               this.a_byteArr[7979 + this.v_int] = (byte)(this.a_byteArr[7979 + this.v_int] & 247);
            }
         }
   ...
   private boolean s_bool() {
      if (this.a_byteArr[1919 + this.v_int] <= 0) {
         ...
         this.a_byteArr[1919 + this.v_int] = this.a_byteArr[6767 + this.v_int] = 1;
         this.a_byteArr[6161 + this.v_int] = 2;
         this.a_byteArr[8282 + this.v_int] = (byte)(this.a_byteArr[8282 + this.v_int] | 128);
      }
   ...
   private void W() {
      if (this.a_obj_f.c_int >= this.b_shortArr[this.c_shortArr[4] + this.a_obj_f.q_byte]) {
         this.w_int = this.a_byteArr[505 + this.v_int]
            ...
            - (this.a_byteArr[2121 + this.v_int] < 20 ? 1 : 0)
            - (this.a_byteArr[2020 + this.v_int] < 20 ? 1 : 0);
         this.w_int = this.w_int
            + (
               this.a_byteArr[4646 + this.v_int] >= 0
                     && this.a_byteArr[2828 + this.v_int] != 92
                     && this.a_byteArr[2828 + this.v_int] != 93
                     && this.a_byteArr[2828 + this.v_int] != 106
                  ? this.b_byteArr[this.a_shortArr[138]
                     + (21 + this.a_byteArr[9115 + this.a_byteArr[4444 + this.v_int]] - 1) * 26
                     + this.a_byteArr[8749 + this.a_byteArr[4444 + this.v_int]]]
                  : 0
            );
   ...
   private void X() {
      if (this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] == this.v_int) {
         if (this.a_byteArr[8080 + this.v_int] > 0) {
            this.a_byteArr[8080 + this.v_int]--;
         }
      } else if (this.a_byteArr[2828 + this.v_int] != 92 && this.a_byteArr[2828 + this.v_int] != 93 && this.a_byteArr[2828 + this.v_int] != 106) {
         this.a_byteArr[8080 + this.v_int] = (byte)b_int2(
            this.a_byteArr[8080 + this.v_int] + ((this.a_byteArr[8871 + this.a_byteArr[4444 + this.v_int]] & 2) != 0 ? 1 : -1), 0, 30
         );
      }

      if (this.a_byteArr[8080 + this.v_int] >= 30) {
         this.a_byteArr[7979 + this.v_int] = (byte)(this.a_byteArr[7979 + this.v_int] | 4);
         this.a_byteArr[8080 + this.v_int] = 0;
      }
   }
         ...
         for (this.o_byte = -1; this.o_byte < 2; this.o_byte++) {
            if (this.a_byteArr[0 + this.v_int] + this.n_byte >= 0
               ...
               if (this.p_byte > 0 && this.p_byte <= 100 && (this.a_byteArr[7979 + this.p_byte] & 4) == 0 && this.a_byteArr[1414 + this.p_byte] >= 12
                ...
                {
                  this.a_byteArr[8080 + this.p_byte] = (byte)(this.a_byteArr[8080 + this.p_byte] + 8);
               }
            }
         }
      }
   ...
   private void Z() {
      if (this.a_obj_f.q_byte != 3) {
         if (this.u_int == 1) {
            ...
            if (this.a_shortArr2[1][18] != -1) {
               return;
            }
         }

         for (this.aH = this.u_int * 30 + 1; this.aH <= (this.u_int + 1) * 30; this.aH++) {
            if (this.a_byteArr[8505 + this.aH] != 0
               && this.a_byteArr[8749 + this.aH] == 2
               && this.a_byteArr[8627 + this.aH] == 0
               && this.a_byteArr[8932 + this.aH] <= 3) {
               if (this.u_int == 0) {
                  if (this.a_byteArr[9237 + this.aH] < 9) {
                     if (this.a_byteArr[9237 + this.aH] >= 3) {
                        this.a_byteArr[9237 + this.aH]++;
                     }
                     continue;
                  }
               } else {
                  ...
                  this.a_shortArr2[this.u_int][18] = 0;
                  if (this.u_int == 1 && this.Q_byte > 0) {
                     return;
                  }

                  this.v_int = this.u_int * 30 + 1;

                  for (this.w_int = 0; this.v_int <= (this.u_int + 1) * 30; this.v_int++) {
                     if (this.a_byteArr[1919 + this.v_int] > 0 && this.a_byteArr[1414 + this.v_int] >= 12) {
                        this.w_int = this.w_int | this.a_byteArr[1515 + this.v_int] + 1;
                     }
                  }
               ...
               this.a_byteArr[4444 + this.v_int] = (byte)this.aH;
               this.a_byteArr[8932 + this.aH]++;
               this.G();
               this.a_byteArr[4545 + this.v_int] = this.a_byteArr[8993 + this.aH];
               this.a_byteArr[8993 + this.aH] = (byte)this.v_int;
               this.a_byteArr[1313 + this.v_int] = -3;
               this.a_byteArr[2929 + this.v_int] = 71;
               this.a_byteArr[3030 + this.v_int] = 0;
               this.a_byteArr[2828 + this.v_int] = 59;
               if (this.u_int == 1) {
                  return;
         ...
         for (this.u_int = 0; this.u_int < 2; this.u_int++) {
            for (this.v_int = this.u_int * 30 + 1; this.v_int <= (this.u_int + 1) * 30; this.v_int++) {
               if (this.a_byteArr[8505 + this.v_int] != 0) {
                  ...
                  if (this.z_int >= 12 || this.z_int == 4 || this.z_int == 2 || this.a_byteArr[8627 + this.v_int] != 0) {
                     this.x_int = this.A_int = 0;
                     if (this.z_int >= 12) {
                        while (this.x_int < 10 && this.f_byteArr2[0][this.x_int] != this.v_int) {
                           this.x_int++;
                        }
                     }

                     if (this.a_byteArr[8627 + this.v_int] != 0) {
                        while (this.x_int < 20 && this.g_byteArr2[0][this.x_int] != this.v_int) {
                           this.x_int++;
                        }
                     }
                     ...
                     if (this.a_byteArr[8627 + this.v_int] == 0
                        || (
                              this.g_byteArr2[2][this.x_int] <= 0
                                 || this.g_byteArr2[1][this.x_int] < this.g_byteArr2[2][this.x_int]
                                 || this.a_byteArr[8627 + this.v_int] != 1
                           )
                           && (this.a_byteArr[8627 + this.v_int] != 2 || this.a_byteArr[8505 + this.v_int] < this.a_byteArr[8566 + this.v_int])
                        ...
                        if (this.z_int == 2 && this.x_int > 0) {
                           if (this.a_byteArr[1313 + this.x_int] == 2 && this.A_int != 3) {
                              this.a_byteArr[1313 + this.x_int] = 1;
                           }

                           if (this.a_byteArr[1313 + this.x_int] == 1 && this.A_int == 3) {
                              this.a_byteArr[1313 + this.x_int] = 2;
                           }
                        }
                        ...
                        if (this.z_int >= 12
                           ...
                           this.a_obj_f
                              .a_byte4(
                                 ...
                                 this.a_byteArr[8383 + this.v_int],
                                 this.a_byteArr[8444 + this.v_int],
                                 1,
                                 true,
                                 this.v_int
                              );
   ...
   private void aa() {
      for (this.w_int = this.a_byteArr[8993 + this.v_int]; this.w_int > 0; this.w_int = this.a_byteArr[4545 + this.w_int]) {
         this.C_int++;
         if (this.z_int == 2 && this.a_byteArr[8627 + this.v_int] == 0) {
            if (this.a_byteArr[4646 + this.w_int] == 0) {
               this.x_int = this.w_int;
            }

            if (this.a_byteArr[1313 + this.w_int] > 0 && this.a_byteArr[2828 + this.w_int] == 111) {
               this.A_int = this.A_int | 1 + this.a_byteArr[1515 + this.w_int];
            }
         } else if (this.z_int >= 12
            && this.a_byteArr[8505 + this.v_int] >= this.b_byteArr[this.a_shortArr[138] + 182 + this.a_byteArr[9237 + this.v_int]]) {
            switch (this.u_int) {
               case 0:
                  this.a_byteArr[2828 + this.w_int] = 87;
                  this.a_byteArr[6161 + this.w_int] = 3;
                  break;
               case 1:
                  this.a_byteArr[6161 + this.w_int] = 2;
            }
         } else if (this.a_byteArr[2828 + this.w_int] != 87
            ...
            && (
               this.a_byteArr[8627 + this.v_int] == 0
                  || this.a_byteArr[2828 + this.w_int] == 56
                  || this.a_byteArr[2828 + this.w_int] == 76
                  || this.a_byteArr[2828 + this.w_int] == 77
                  || this.a_byteArr[2828 + this.w_int] == 78
            )) {
            this.ab();
         }
      }
   ...
   private void ab() {
      if (this.a_byteArr[4646 + this.w_int] == 0) {
         if (this.a_byteArr[6161 + this.w_int] == 2) {
            return;
         }

         if (this.a_byteArr[8627 + this.v_int] != 0) {
            if (this.g_byteArr2[1][this.x_int] >= this.g_byteArr2[2][this.x_int]) {
               this.g_byteArr2[1][this.x_int] = this.g_byteArr2[2][this.x_int] = 0;
            }

            if (this.g_byteArr2[2][this.x_int] == 0) {
               this.a_void7(this.w_int, (byte)99);
               this.a_byteArr[6161 + this.w_int] = 3;
            }
         } else if (this.f_byteArr2[1][this.x_int] < this.b_byteArr[this.a_shortArr[80] + this.a_byteArr[9237 + this.v_int]] && this.z_int >= 12
            || this.z_int == 4 && this.a_shortArr2[this.u_int][0] < 40 && this.a_byteArr[2828 + this.w_int] == 66) {
            this.a_byteArr[6161 + this.w_int] = 3;
            if (this.z_int >= 12) {
               this.a_void7(
                  this.w_int,
                  this.b_byteArr[this.a_shortArr[81] + this.b_byteArr[this.a_shortArr[82] + this.a_byteArr[9237 + this.v_int]] + this.f_byteArr2[1][this.x_int]]
               );
            } else if (this.a_byteArr[3636 + this.w_int] <= 0
               || this.a_byteArr[3535 + this.w_int] != 1
                  && this.a_byteArr[3535 + this.w_int] != 5
                  && this.a_byteArr[3535 + this.w_int] != 6
                  && this.a_byteArr[3535 + this.w_int] != 7) {
               this.a_void7(this.w_int, (byte)37);
            } else {
               this.a_void7(this.w_int, (byte)54);
               this.a_byteArr[6161 + this.w_int] = 0;
            }
         }

         if (this.a_byteArr[8749 + this.v_int] == 6 || this.a_byteArr[8749 + this.v_int] == 16 && this.a_byteArr[9237 + this.v_int] == 6) {
            if (this.a_byteArr[6161 + this.w_int] == 3) {
               this.a_byteArr[6161 + this.w_int] = 0;
               if (this.a_bool7(this.a_byteArr[2828 + this.w_int], false, this.w_int)) {
                  if (this.a_byteArr[8749 + this.v_int] == 16) {
                     this.f_byteArr2[1][this.x_int]++;
                  }
               ...
               this.f_bool = true;
               if (this.a_byteArr[8749 + this.v_int] != 6
                  && this.a_byteArr[8505 + this.v_int]
                     < this.b_byteArr[this.a_shortArr[83]
                        + this.b_byteArr[this.a_shortArr[84] + this.a_byteArr[9237 + this.v_int]]
                        + this.f_byteArr2[1][this.x_int]]) {
                  this.f_bool = false;
               }

               this.d_void4(this.f_bool);
               return;
            }
      ...
      } else if (this.a_byteArr[2828 + this.w_int] != 59) {
         if (this.a_byteArr[8627 + this.v_int] != 0) {
            if (this.g_byteArr2[1][this.x_int] < this.g_byteArr2[2][this.x_int]) {
               this.a_void7(
                  this.w_int, this.b_byteArr[this.a_shortArr[60] + this.b_byteArr[this.a_shortArr[177] + this.z_int] + this.a_byteArr[4646 + this.w_int]]
               );
               return;
            }

            this.a_void7(
               this.w_int, this.b_byteArr[this.a_shortArr[59] + this.b_byteArr[this.a_shortArr[177] + this.z_int] + this.a_byteArr[4646 + this.w_int]]
            );
            return;
         }

         if (this.a_byteArr[8505 + this.v_int]
                  < this.b_byteArr[this.a_shortArr[83]
                     + this.b_byteArr[this.a_shortArr[84] + this.a_byteArr[9237 + this.v_int]]
                     + this.f_byteArr2[1][this.x_int]]
               && this.z_int >= 12
            || this.z_int == 4 && this.a_shortArr2[this.u_int][0] > 0) {
            this.a_void7(
               this.w_int, this.b_byteArr[this.a_shortArr[58] + this.b_byteArr[this.a_shortArr[174] + this.z_int] + this.a_byteArr[4646 + this.w_int]]
            );
            return;
         }

         this.a_void7(
            this.w_int, this.b_byteArr[this.a_shortArr[57] + this.b_byteArr[this.a_shortArr[174] + this.z_int] + this.a_byteArr[4646 + this.w_int]]
         );
      }
   }
   ...
   private void ac() {
      ...
      this.a_byteArr[8932 + this.v_int] = (byte)this.C_int;
   }
   ...
   private void ad() {
      ...
      this.a_byteArr[9054 + this.v_int] = (byte)(this.a_byteArr[9054 + this.v_int] & 254);
      this.a_byteArr[8627 + this.v_int] = 0;
   ...
   private void ae() {
      if ((this.u_int != 0 || !this.a_obj_f.N_bool) && (this.u_int != 1 || this.Q_byte <= 0)) {
         ...
         if (this.a_byteArr[9298 + this.v_int] < this.a_byteArr[8932 + this.v_int] && this.a_byteArr[8810 + this.v_int] > 0) {
            this.a_byteArr[9298 + this.v_int] = this.a_byteArr[8932 + this.v_int];
         }

         if (this.a_byteArr[9298 + this.v_int] < this.aK) {
            for (this.aL = this.u_int * 50 + 1;
               ...
               if ((
                     this.u_int == 0
                           && (
                              this.a_byteArr[2828 + this.aL] == 69
                                 || this.a_byteArr[2828 + this.aL] == 84 && this.a_byteArr[3939 + this.aL] == 69
                           )
                           && this.a_byteArr[6161 + this.aL] == 0
                  ...
                  this.a_byteArr[6464 + this.aL] = this.a_byteArr[2828 + this.aL] = 77;
                  this.a_byteArr[6161 + this.aL] = 3;
                  this.a_byteArr[9298 + this.v_int]++;
                  if (this.b_byteArr2[this.a_byteArr[101 + this.aL]][this.a_byteArr[0 + this.aL]] != this.aL) {
                     this.a_byteArr[2828 + this.aL] = 87;
                  }
               }
            }
   ...
   private void d_void4(boolean var1) {
      if (var1) {
         ...
         if (this.a_byteArr[2929 + this.w_int] != 115 && this.a_byteArr[2929 + this.w_int] != 113) {
            ...
            this.a_byteArr[3030 + this.w_int] = -1;
            this.a_byteArr[1313 + this.w_int] = 1;
            return;
         }
         ...
         if (this.a_byteArr[2929 + this.w_int] == 115 || this.a_byteArr[2929 + this.w_int] == 113) {
            this.a_byteArr[2929 + this.w_int] = 116;
            this.a_byteArr[3030 + this.w_int] = -1;
            return;
         }
   ...
   final void h_void2() {
      try {
         ...
         for (this.v_int = 0; this.v_int < 22; this.v_int++) {
            if (this.a_byteArr[9513 + this.v_int] > 0) {
               this.af();
               this.ah();
            }
         }
   ...
   private void af() {
      ...
      if (this.a_byteArr[9579 + this.v_int] >= this.a_obj_f.j_byteArr2[4][this.a_byteArr[9557 + this.v_int] & 255]) {
         ...
         if (this.a_byteArr[9557 + this.v_int] == 37 + this.a_byteArr[9535 + this.v_int]) {
            this.a_bool11(
               this.a_byteArr[9359 + this.v_int] + this.b_byteArr[this.a_shortArr[1] + this.a_byteArr[9491 + this.v_int]],
               this.a_byteArr[9381 + this.v_int] + this.b_byteArr[this.a_shortArr[1] + 8 + this.a_byteArr[9491 + this.v_int]],
               2,
      ...
      if (this.a_byteArr[9403 + this.v_int] == 0 && this.a_byteArr[9425 + this.v_int] == 0) {
         this.a_byteArr[9623 + this.v_int] = 0;
         if (this.a_byteArr[9447 + this.v_int] > 5) {
            if (this.a_byteArr[9447 + this.v_int] > 19) {
               this.a_byteArr[9447 + this.v_int] = (byte)(this.a_byteArr[9447 + this.v_int] - 19);
               this.a_void9(
                  this.a_byteArr[0 + this.a_byteArr[9447 + this.v_int]],
                  this.a_byteArr[101 + this.a_byteArr[9447 + this.v_int]],
                  this.a_byteArr[9447 + this.v_int],
                  0
               );
            } else {
               this.e_void3(false);
               this.a_byteArr[9557 + this.v_int] = (byte)(10 + this.a_byteArr[9535 + this.v_int]);
               this.a_byteArr[9579 + this.v_int] = 0;
            }
            ...
            if (this.a_byteArr[9601 + this.v_int] != 0) {
               if (this.a_byteArr[9601 + this.v_int] > 0) {
                  if (this.a_byteArr[1919 + this.a_byteArr[9601 + this.v_int]] > 0
                     && this.b_byteArr2[this.a_byteArr[101 + this.a_byteArr[9601 + this.v_int]]][this.a_byteArr[0 + this.a_byteArr[9601 + this.v_int]]]
                        == this.a_byteArr[9601 + this.v_int]) {
                     this.a_byteArr[9645 + this.v_int] = this.a_byteArr[0 + this.a_byteArr[9601 + this.v_int]];
               ...
               } else if (this.a_byteArr[8505 + -this.a_byteArr[9601 + this.v_int]] <= 0) {
                  this.a_byteArr[9601 + this.v_int] = 0;
               }
            }
         }

         this.z_int = this.a_int2(this.a_byteArr[9359 + this.v_int], this.a_byteArr[9381 + this.v_int], 101);
         this.ag();
      } else {
         this.a_byteArr[9557 + this.v_int] = (byte)(2 + this.a_byteArr[9535 + this.v_int]);
      }
   }
   ...
   private void ag() {
      if (this.z_int / 10 - (this.a_byteArr[9601 + this.v_int] != 0 ? 1 : 0) > 0) {
         if (this.a_byteArr[9711 + this.v_int] >= this.a_byteArr[9689 + this.v_int]) {
            if (this.a_obj_f.c_int % this.b_byteArr[this.a_shortArr[179] + this.a_byteArr[9535 + this.v_int]] == 0
               ...
               this.a_byteArr[9689 + this.v_int] = this.a_byte2(
                  ...
                  this.a_byteArr[9667 + this.v_int],
                  this.a_byteArr[9645 + this.v_int],
                  0,
                  101
               );
               if (this.a_byteArr[9689 + this.v_int] == 0 && this.a_boolArr[2]) {
                  this.e_void3(false);
               }
            }

            if (this.a_byteArr[9557 + this.v_int] > 7 || this.a_byteArr[9711 + this.v_int] >= this.a_byteArr[9689 + this.v_int]) {
               this.a_byteArr[9557 + this.v_int] = (byte)(10 + this.a_byteArr[9535 + this.v_int]);
               this.a_byteArr[9579 + this.v_int] = 0;
            }
         }
         ...
         if (this.a_byteArr[9711 + this.v_int] < this.a_byteArr[9689 + this.v_int]) {
            if (this.b_byteArr2[this.b_byteArr3[1][this.v_int][this.a_byteArr[9711 + this.v_int]]][this.b_byteArr3[0][this.v_int][this.a_byteArr[9711
                  + this.v_int]]]
               != 0) {
               this.a_byteArr[9689 + this.v_int] = this.a_byteArr[9711 + this.v_int] = 0;
               this.a_byteArr[9557 + this.v_int] = (byte)(10 + this.a_byteArr[9535 + this.v_int]);
            ...
            this.a_byteArr[9491 + this.v_int] = this.b_byteArr[this.a_shortArr[4]
               + (this.b_byteArr3[0][this.v_int][this.a_byteArr[9711 + this.v_int]] - this.a_byteArr[9359 + this.v_int] + 1) * 3
               + this.b_byteArr3[1][this.v_int][this.a_byteArr[9711 + this.v_int]]
               - this.a_byteArr[9381 + this.v_int]
               + 1];
            this.a_byteArr[9557 + this.v_int] = (byte)(2 + this.a_byteArr[9535 + this.v_int]);
            this.b_byteArr2[this.a_byteArr[9381 + this.v_int] + this.b_byteArr[this.a_shortArr[1] + 8 + this.a_byteArr[9491 + this.v_int]]][this.a_byteArr[9359
                  + this.v_int]
               + this.b_byteArr[this.a_shortArr[1] + this.a_byteArr[9491 + this.v_int]]] = -128;
            this.a_byteArr[9711 + this.v_int]++;
            this.a_byteArr[9447 + this.v_int] = 0;
            return;
         }
      } else {
         if ((this.a_byteArr[9557 + this.v_int] & 255) <= 7) {
            this.a_byteArr[9579 + this.v_int] = 0;
         }

         if (this.a_byteArr[9579 + this.v_int] == 0) {
            if (this.a_byteArr[9447 + this.v_int] == 0) {
               this.ai();
            }

            if (this.a_byteArr[9601 + this.v_int] == 0 && this.a_byteArr[9447 + this.v_int] < 19) {
               this.a_byteArr[9447 + this.v_int]++;
               return;
            }

            this.a_byteArr[9447 + this.v_int] = 0;
            this.a_byteArr[9491 + this.v_int] = (byte)(this.z_int % 10);
         }
      }
   }
   ...
   private void ah() {
      if ((this.a_byteArr[9557 + this.v_int] & 255) <= 7) {
         this.w_int = this.a_byteArr[9491 + this.v_int] & 1;
         this.a_byteArr[9623 + this.v_int]++;
         this.a_byteArr[9403 + this.v_int] = this.b_byteArr[this.a_shortArr[5 + this.w_int]
            + this.b_byteArr[this.a_shortArr[12 + this.w_int * 2] + this.b_byteArr[this.a_shortArr[179] + this.a_byteArr[9535 + this.v_int]]]
            + (
                  this.b_byteArr[this.a_shortArr[15] + this.w_int * 9 + this.b_byteArr[this.a_shortArr[179] + this.a_byteArr[9535 + this.v_int]]]
                     + this.a_byteArr[9623 + this.v_int] * this.b_byteArr[this.a_shortArr[1] + 0 + this.a_byteArr[9491 + this.v_int]]
               )
               % this.b_byteArr[this.a_shortArr[15] + this.w_int * 9 + this.b_byteArr[this.a_shortArr[179] + this.a_byteArr[9535 + this.v_int]]]];
         this.a_byteArr[9425 + this.v_int] = this.b_byteArr[this.a_shortArr[7 + this.w_int]
            + this.b_byteArr[this.a_shortArr[12 + this.w_int * 2] + this.b_byteArr[this.a_shortArr[179] + this.a_byteArr[9535 + this.v_int]]]
            + (
                  this.b_byteArr[this.a_shortArr[15] + this.w_int * 9 + this.b_byteArr[this.a_shortArr[179] + this.a_byteArr[9535 + this.v_int]]]
                     + this.a_byteArr[9623 + this.v_int] * this.b_byteArr[this.a_shortArr[1] + 8 + this.a_byteArr[9491 + this.v_int]]
               )
               % this.b_byteArr[this.a_shortArr[15] + this.w_int * 9 + this.b_byteArr[this.a_shortArr[179] + this.a_byteArr[9535 + this.v_int]]]];
         if (this.a_byteArr[9623 + this.v_int]
            == (this.b_byteArr[this.a_shortArr[15] + this.w_int * 9 + this.b_byteArr[this.a_shortArr[179] + this.a_byteArr[9535 + this.v_int]]] + 1) / 2) {
            this.b_byteArr2[this.a_byteArr[9381 + this.v_int]][this.a_byteArr[9359 + this.v_int]] = 0;
            this.a_byteArr[9359 + this.v_int] = (byte)(
               this.a_byteArr[9359 + this.v_int] + this.b_byteArr[this.a_shortArr[1] + 0 + this.a_byteArr[9491 + this.v_int]]
            );
            this.a_byteArr[9381 + this.v_int] = (byte)(
               this.a_byteArr[9381 + this.v_int] + this.b_byteArr[this.a_shortArr[1] + 8 + this.a_byteArr[9491 + this.v_int]]
            );
            if ((this.b_byteArr[this.a_shortArr[15] + this.w_int * 9 + this.b_byteArr[this.a_shortArr[179] + this.a_byteArr[9535 + this.v_int]]] & 1) == 0
               && this.b_byteArr[this.a_shortArr[1] + 0 + this.a_byteArr[9491 + this.v_int]] < 0) {
               this.a_byteArr[9403 + this.v_int] = (byte)(this.a_byteArr[9403 + this.v_int] + 22);
            }

            if ((this.b_byteArr[this.a_shortArr[15] + this.w_int * 9 + this.b_byteArr[this.a_shortArr[179] + this.a_byteArr[9535 + this.v_int]]] & 1) == 0
               && this.b_byteArr[this.a_shortArr[1] + 8 + this.a_byteArr[9491 + this.v_int]] < 0) {
               this.a_byteArr[9425 + this.v_int] = (byte)(this.a_byteArr[9425 + this.v_int] + 16);
            }

            this.b_byteArr2[this.a_byteArr[9381 + this.v_int]][this.a_byteArr[9359 + this.v_int]] = (byte)(this.v_int + 101);
         }
      }
   }
   ...
   final void i_void2() {
      for (this.aM = 0; this.aM < 50; this.aM++) {
         if (this.a_byteArr[9833 + this.aM] != 0) {
            ...
            for (this.w_int = 0; this.w_int <= 3; this.w_int++) {
         ...
         if (this.N_int >= 3 && this.N_int <= 9) {
            if (this.N_int == 7) {
               ...
               if (this.N_int == 8) {
                  ...
                  this.a_void16(8, 21, 75, (byte)1, (byte)3);

                  for (this.N_int = 51; this.N_int <= 100; this.N_int++) {
                     if (this.a_byteArr[1919 + this.N_int] > 0) {
                        this.a_byteArr[6161 + this.N_int] = 2;
                        this.a_byteArr[4747 + this.N_int] = -1;
                        this.a_byteArr[3131 + this.N_int] = this.a_byteArr[8384];
         ...
         if (this.J_byte < 120 - this.b_byteArr[this.a_shortArr[298] + this.g_byte]) {
            switch (this.b_byteArr[this.a_shortArr[296] + this.g_byte]) {
               ...
               case 2:
                  for (this.v_int = 1; this.v_int <= 50; this.v_int++) {
                     if (this.a_byteArr[1919 + this.v_int] > 0
                        && this.b_byteArr[this.a_shortArr[41] + this.a_byteArr[2828 + this.v_int]] == this.b_byteArr[this.a_shortArr[297] + this.g_byte]) {
                        this.J_byte = (byte)(120 - this.b_byteArr[this.a_shortArr[298] + this.g_byte]);
                        break;
                     }
                  }
   ...
   private void am() {
      for (this.u_int = 0; this.u_int < 2; this.u_int++) {
         for (this.v_int = this.u_int * 50 + 1; this.v_int <= (this.u_int + 1) * 50; this.v_int++) {
            if (this.a_byteArr[3232 + this.v_int] == this.a_byteArr[9783 + this.aM]
               && (this.a_byteArr[3131 + this.v_int] == this.a_byteArr[9733 + this.aM] || this.a_byteArr[2828 + this.v_int] == 13)
               && this.a_byteArr[2828 + this.v_int] >= 10
               && this.a_byteArr[2828 + this.v_int] <= 16) {
               if (this.a_byteArr[4444 + this.v_int] >= 0) {
                  this.a_byteArr[4444 + this.v_int] = -1;
               ...
               if ((this.a_byteArr[2828 + this.v_int] == 16 || this.a_byteArr[2828 + this.v_int] == 12) && this.a_byteArr[3636 + this.v_int] > 0) {
                  this.a_void7(this.v_int, this.b_byteArr[this.a_shortArr[160] + this.a_byteArr[2828 + this.v_int]]);
                  this.N();
               }
            }
         }
   ...
   private void an() {
      if (this.a_byteArr[2828 + this.v_int] >= 10
         && this.a_byteArr[2828 + this.v_int] <= 16
         && this.a_byteArr[2828 + this.v_int] != 11
         && this.a_byteArr[2828 + this.v_int] != 14) {
         this.a_byteArr[3131 + this.v_int] = this.a_byteArr[6262 + this.v_int];
         this.a_byteArr[3232 + this.v_int] = this.a_byteArr[6363 + this.v_int];
         if (this.c_bool4(this.b_byteArr2[this.a_byteArr[6363 + this.v_int]][this.a_byteArr[6262 + this.v_int]])) {
            this.g_void(1);
            return;
         }

         if (!this.b_bool7(false)) {
            if (this.a_byteArr[3636 + this.v_int] > 0) {
               this.a_void7(this.v_int, this.b_byteArr[this.a_shortArr[160] + this.a_byteArr[2828 + this.v_int]]);
               this.N();
               return;
            }
   ...
   private int a_int3(int var1) {
      for (this.aN = 0; this.aN < 10; this.aN++) {
         if (this.a_obj_f.a_byteArr3[this.u_int][this.aN][11] > 0) {
            ...
            if (this.v_int > 0 && this.a_byteArr[2828 + this.v_int] == 58 && this.a_byteArr[1313 + this.v_int] >= 0) {
               ...
               if (this.aO != 10) {
                  this.a_void7(this.v_int, this.b_byteArr[this.a_shortArr[86] + this.aO]);
                  if (this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] == this.v_int) {
                     this.N();
                  } else {
                     this.a_byteArr[6161 + this.v_int] = 3;
      ...
      for (this.aN = this.u_int * 30 + 1; this.aN <= (this.u_int + 1) * 30; this.aN++) {
         if (this.a_byteArr[8505 + this.aN] > 0 && this.a_byteArr[8749 + this.aN] == 8 && this.a_byteArr[8810 + this.aN] >= 1) {
            this.v_int = this.a_byteArr[8810 + this.aN];
            if (this.a_byteArr[2828 + this.v_int] == 57
               && this.a_byteArr[1313 + this.v_int] >= 0
               && this.a_byteArr[2929 + this.v_int] != -109
               && (
                  this.a_byteArr[8932 + this.aN] == 1
                     || this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] == this.v_int
               )) {
               this.aO = 0;
   ...
   private void ap() {
      this.ao();
      this.a_void7(this.v_int, (byte)57);
      this.N();
      this.v_int = this.a_int3(this.v_int);
      this.z_int = this.a_int2(this.a_byteArr[0 + this.v_int], this.a_byteArr[101 + this.v_int], 0);
      this.p_void();
         ...
         if (this.P_byte != -1) {
            ...
            if (this.a_obj_f
                  .a_byte4(
                     ...
                     this.b_byteArr[this.a_shortArr[245] + (this.P_byte & 255)],
                     this.b_byteArr[this.a_shortArr[246] + (this.P_byte & 255)],
                     3,
                     true,
                     -1
                  )
      ...
      if (this.f_byte >= this.b_byteArr[this.a_shortArr[217] + this.a_obj_f.q_byte]) {
         if ((this.a_obj_f.c_int & 63) == 25) {
            ...
            for (this.v_int = 1; this.v_int <= 50; this.v_int++) {
               if (this.a_byteArr[1919 + this.v_int] > 0
                  && this.a_byteArr[1414 + this.v_int] >= 12
                  && this.a_byteArr[0 + this.v_int] >= this.b_byteArr[this.aT]
                  && this.a_byteArr[101 + this.v_int] >= this.b_byteArr[this.aT + 1]
                  && this.a_byteArr[0 + this.v_int] <= this.b_byteArr[this.aT + 2]
                  && this.a_byteArr[101 + this.v_int] <= this.b_byteArr[this.aT + 3]) {
                  this.Q_byte = (byte)this.v_int;

                  for (this.w_int = 51; this.w_int <= 100; this.w_int++) {
                     if (this.a_byteArr[1919 + this.w_int] > 0
                        && this.a_byteArr[1414 + this.w_int] >= 12
                        && (this.a_byteArr[7979 + this.w_int] & 64) == 0) {
                        this.a_byteArr[7979 + this.w_int] = (byte)(this.a_byteArr[7979 + this.w_int] | 32);
                     }
                  }
                  break;
               }
         ...
         for (this.v_int = this.u_int * 50 + 1 + 0; this.v_int <= (this.u_int + 1) * 50; this.v_int++) {
            this.aT = (byte)(this.v_int - this.u_int * 50 - 1);
            if (this.a_byteArr[1919 + this.v_int] > 0 && this.a_byteArr[1414 + this.v_int] >= 12) {
               if ((this.a_byteArr[7979 + this.v_int] & 64) != 0) {
                  if (this.O_byte < 0
                     && (this.a_byteArr[7979 + this.v_int] & 2) != 0
                     && this.a_int2(this.a_byteArr[0 + this.v_int], this.a_byteArr[101 + this.v_int], 0) < 29
                     && this.a_byteArr[202 + this.v_int] == 0
                     && this.a_byteArr[303 + this.v_int] == 0) {
                     this.a_byteArr[3131 + this.v_int] = this.a_byteArr[8384];
                     this.a_byteArr[3232 + this.v_int] = this.a_byteArr[8445];
               ...
               for (this.aU = this.u_int * 50 + 1; this.aU <= (this.u_int + 1) * 50; this.aU++) {
                  if (this.j_byteArr[this.aU - this.u_int * 50 - 1] >= this.M_byte
                     ...
                     && this.a_byteArr[1414 + this.v_int] >= 12) {
                     this.j_byteArr[this.aU - this.u_int * 50 - 1] = this.j_byteArr[this.aT];
                     this.j_byteArr[this.aT] = this.M_byte;
                     break;
                  }
               }
            }
      ...
      if (this.Q_byte < 0) {
         if (this.j_byteArr[this.aT] < this.M_byte) {
            ...
            if (this.a_byteArr[6565 + this.v_int] != this.x_int) {
               this.a_byteArr[6565 + this.v_int] = (byte)this.x_int;
            }
         } else if (this.a_byteArr[6565 + this.v_int] == 9) {
            this.o_void2(-1);
         }
      }
      ...
      if ((this.a_obj_f.c_int & 15) == (this.v_int & 15)) {
         ...
         if (this.Q_byte < 0 && !var1) {
            if (this.j_byteArr[this.aT] < this.M_byte) {
               ...
               || this.a_byteArr[2828 + this.v_int] == 84 && this.a_byteArr[3939 + this.v_int] == 69
               || this.b_byteArr[this.a_shortArr[41] + this.a_byteArr[2828 + this.v_int]] >= 13
                  && this.b_byteArr[this.a_shortArr[41] + this.a_byteArr[2828 + this.v_int]] <= 15
                  && this.b_byteArr2[this.a_byteArr[101 + this.v_int]][this.a_byteArr[0 + this.v_int]] == this.v_int) {
               ...
               if (this.a_byteArr[this.b_shortArr[this.b_byteArr[this.a_shortArr[107] + this.x_int]] + this.v_int] < this.w_int) {
                  if (this.a_bool8(this.b_byteArr[this.a_shortArr[114] + this.x_int])) {
                     this.a_void7(this.v_int, this.b_byteArr[this.a_shortArr[114] + 3 + this.x_int]);
                     this.a_byteArr[6161 + this.v_int] = 3;
                     return;
                  }
   ...
   private void av() {
      ...
      if (this.a_obj_f.q_byte < 7 || this.a_obj_f.c_int >= this.A_int / 7) {
         ...
         for (this.v_int = this.u_int * 50 + 1; this.v_int <= (this.u_int + 1) * 50; this.v_int++) {
            if (this.a_byteArr[1919 + this.v_int] > 0
               && this.a_byteArr[1414 + this.v_int] >= 12
               && this.j_byteArr[this.v_int - this.u_int * 50 - 1] >= this.M_byte
               && (this.a_byteArr[7979 + this.v_int] & 64) == 0
               && this.a_byteArr[6565 + this.v_int] != 9
               && (this.a_byteArr[1515 + this.v_int] != 1 || (this.R_byte & 128) == 0)
               && (
                  this.a_byteArr[1717 + this.v_int] >= this.y_int / 2
                     || this.a_byteArr[1616 + this.v_int] >= this.y_int / 2
                     || this.a_byteArr[7575 + this.v_int] >= this.y_int / 2
               )
               && (this.z_int < 2 || this.a_byteArr[7575 + this.v_int] <= 3)) {
      ...
      for (this.a_int = 0; this.a_int < var1; this.a_int++) {
         ...
         if ((this.b_int = this.a_obj_f.a_byte3(var4, (byte)var6, (byte)var7, (byte)20, (byte)0)) > 0) {
            ...
            if (this.aU >= 0 && var4 == 1) {
               ...
               this.L();
               this.a_byteArr[7979 + this.b_int] = (byte)(this.a_byteArr[7979 + this.b_int] | 64);
            }
         }
      }
   }
   ...
   final void l_void2() {
      ...
      for (this.a_int = 0; this.a_int < 22; this.a_int++) {
         this.l_void(this.a_int);
      }
   }
   ...
   // $VF: renamed from: a () byte
   private byte a_byte6() {
      if (this.k_byteArr[3] == 0) {
         if (this.k_byteArr[0] == 2) {
            if (this.k_byteArr[1] != 10 && this.a_byteArr[1414 + this.v_int] < 12) {
               return 11;
            }

            if (this.k_byteArr[1] == 2
               && this.a_byteArr[8627 + this.k_byteArr[2]] == 0
               && this.a_byteArr[9237 + this.k_byteArr[2]] > 1
               && this.a_byteArr[2828 + this.v_int] != 111) {
               return 13;
            }

            if (this.a_byteArr[8627 + this.k_byteArr[2]] != 1 && this.a_byteArr[8627 + this.k_byteArr[2]] != 2) {
               if (this.k_byteArr[1] == 1 && this.b_byteArr[this.a_shortArr[77] + this.a_byteArr[6565 + this.v_int]] != -1) {
                  return 6;
               }

               if (this.k_byteArr[1] == 5 && this.b_byteArr[this.a_shortArr[77] + this.a_byteArr[6565 + this.v_int]] < 0) {
                  return 7;
               }

               if (this.k_byteArr[1] == 10 && this.a_byteArr[1414 + this.v_int] >= 11) {
                  return 9;
               }

               if (this.k_byteArr[1] == 3 && this.v_int != this.a_shortArr2[0][17]) {
                  return 10;
               }

               if (this.a_byteArr[8810 + this.k_byteArr[2]] > 0 && this.a_byteArr[8810 + this.k_byteArr[2]] != this.v_int) {
                  this.k_byte = 7;
               }
            } else {
               this.k_byte = 8;
            }
         } else if (this.k_byteArr[0] == 3 && this.k_byteArr[1] == 5 && this.a_byteArr[6565 + this.v_int] != 2) {
            return 8;
         }
      }
      ...
      for (this.a_int = 0; this.a_int < 6; this.a_int++) {
         if (this.a_obj_f.l_int != 1) {
            ...
            if (this.d_shortArr[this.a_int] >= 0) {
               this.d_shortArr[this.a_int]++;
            }

            if (this.d_shortArr[this.a_int] >= this.b_shortArr[this.c_shortArr[2] + this.a_int]) {
               this.d_shortArr[this.a_int] = -1;
            }
         }
      }
